...
const Serializer_1 = __webpack_require__(5919);
const utils_1 = __webpack_require__(7956);
/**
...
// @ts-ignore
const protocol_proto_js_1 = __webpack_require__(8243);
const utils_1 = __webpack_require__(7956);
...
exports.utils = __importStar(__webpack_require__(3588));
exports.interfaces = __importStar(__webpack_require__(8861));
__exportStar(__webpack_require__(8029), exports);
__exportStar(__webpack_require__(196), exports);
__exportStar(__webpack_require__(9222), exports);
__exportStar(__webpack_require__(5919), exports);
        ...
        koinos.protocol = (function () {
            ...
            protocol.event_data = (function () {
                ...
                event_data.verify = function verify(message) {
                    ...
                    if (message.source != null && message.hasOwnProperty("source"))
                        if (!((message.source && typeof message.source.length === "number") ||
                ...
                event_data.toObject = function toObject(message, options) {
                    ...
                    if (message.impacted && message.impacted.length) {
                        ...
                        for (var j = 0; j < message.impacted.length; ++j)
                            object.impacted[j] =
                                options.bytes === String
                                    ? $util.base64.encode(message.impacted[j], 0, message.impacted[j].length)
                                    : options.bytes === Array
            ...
            protocol.contract_call_bundle = (function () {
                ...
                contract_call_bundle.toObject = function toObject(message, options) {
                    ...
                    if (message.contract_id != null &&
                        ...
                        object.contract_id =
                            options.bytes === String
                                ? $util.base64.encode(message.contract_id, 0, message.contract_id.length)
                                : options.bytes === Array
            ...
            protocol.system_call_target = (function () {
                ...
                system_call_target.encode = function encode(message, writer) {
                    ...
                    if (message.system_call_bundle != null &&
                        Object.hasOwnProperty.call(message, "system_call_bundle"))
                        $root.koinos.protocol.contract_call_bundle
                            .encode(message.system_call_bundle, writer.uint32(/* id 2, wireType 2 =*/ 18).fork())
                            .ldelim();
                    return writer;
                };
                /**
                ...
                system_call_target.fromObject = function fromObject(object) {
                    ...
                    if (object.system_call_bundle != null) {
                        ...
                        message.system_call_bundle =
                            $root.koinos.protocol.contract_call_bundle.fromObject(object.system_call_bundle);
                    }
                    return message;
                };
                /**
                ...
                system_call_target.toObject = function toObject(message, options) {
                    ...
                    if (message.system_call_bundle != null &&
                        ...
                        object.system_call_bundle =
                            $root.koinos.protocol.contract_call_bundle.toObject(message.system_call_bundle, options);
                        if (options.oneofs)
            ...
            protocol.upload_contract_operation = (function () {
                ...
                upload_contract_operation.encode = function encode(message, writer) {
                    ...
                    if (message.authorizes_call_contract != null &&
                    ...
                    if (message.authorizes_transaction_application != null &&
                        Object.hasOwnProperty.call(message, "authorizes_transaction_application"))
                        writer
                            .uint32(/* id 5, wireType 0 =*/ 40)
                            .bool(message.authorizes_transaction_application);
                    if (message.authorizes_upload_contract != null &&
            ...
            protocol.call_contract_operation = (function () {
                ...
                call_contract_operation.verify = function verify(message) {
                    ...
                    if (message.args != null && message.hasOwnProperty("args"))
                        if (!((message.args && typeof message.args.length === "number") ||
            ...
            protocol.set_system_call_operation = (function () {
                ...
                set_system_call_operation.encode = function encode(message, writer) {
                    ...
                    if (message.target != null &&
                        ...
                        $root.koinos.protocol.system_call_target
                            .encode(message.target, writer.uint32(/* id 2, wireType 2 =*/ 18).fork())
                            .ldelim();
                    return writer;
                };
                /**
                ...
                set_system_call_operation.fromObject = function fromObject(object) {
                    ...
                    if (object.target != null) {
                        ...
                        message.target =
                            $root.koinos.protocol.system_call_target.fromObject(object.target);
                    }
                    return message;
                };
                /**
                ...
                set_system_contract_operation.encode = function encode(message, writer) {
                    ...
                    if (message.contract_id != null &&
                        ...
                        writer
                            .uint32(/* id 1, wireType 2 =*/ 10)
                            .bytes(message.contract_id);
                    if (message.system_contract != null &&
            ...
            protocol.operation = (function () {
                ...
                operation.encode = function encode(message, writer) {
                    if (!writer)
                        writer = $Writer.create();
                    if (message.upload_contract != null &&
                        Object.hasOwnProperty.call(message, "upload_contract"))
                        $root.koinos.protocol.upload_contract_operation
                            .encode(message.upload_contract, writer.uint32(/* id 1, wireType 2 =*/ 10).fork())
                            .ldelim();
                    if (message.call_contract != null &&
                        Object.hasOwnProperty.call(message, "call_contract"))
                        $root.koinos.protocol.call_contract_operation
                            .encode(message.call_contract, writer.uint32(/* id 2, wireType 2 =*/ 18).fork())
                            .ldelim();
                    if (message.set_system_call != null &&
                        Object.hasOwnProperty.call(message, "set_system_call"))
                        $root.koinos.protocol.set_system_call_operation
                            .encode(message.set_system_call, writer.uint32(/* id 3, wireType 2 =*/ 26).fork())
                            .ldelim();
                    if (message.set_system_contract != null &&
                        Object.hasOwnProperty.call(message, "set_system_contract"))
                        $root.koinos.protocol.set_system_contract_operation
                            .encode(message.set_system_contract, writer.uint32(/* id 4, wireType 2 =*/ 34).fork())
                            .ldelim();
                    return writer;
                };
                /**
                ...
                operation.fromObject = function fromObject(object) {
                    ...
                    if (object.upload_contract != null) {
                        ...
                        message.upload_contract =
                            $root.koinos.protocol.upload_contract_operation.fromObject(object.upload_contract);
                    }
                    if (object.call_contract != null) {
                        ...
                        message.call_contract =
                            $root.koinos.protocol.call_contract_operation.fromObject(object.call_contract);
                    }
                    if (object.set_system_call != null) {
                        ...
                        message.set_system_call =
                            $root.koinos.protocol.set_system_call_operation.fromObject(object.set_system_call);
                    }
                    if (object.set_system_contract != null) {
                        ...
                        message.set_system_contract =
                            $root.koinos.protocol.set_system_contract_operation.fromObject(object.set_system_contract);
                    }
                    return message;
                };
                /**
                ...
                operation.toObject = function toObject(message, options) {
                    ...
                    if (message.upload_contract != null &&
                        ...
                        object.upload_contract =
                            $root.koinos.protocol.upload_contract_operation.toObject(message.upload_contract, options);
                        if (options.oneofs)
                    ...
                    if (message.call_contract != null &&
                        ...
                        object.call_contract =
                            $root.koinos.protocol.call_contract_operation.toObject(message.call_contract, options);
                        if (options.oneofs)
                    ...
                    if (message.set_system_call != null &&
                        ...
                        object.set_system_call =
                            $root.koinos.protocol.set_system_call_operation.toObject(message.set_system_call, options);
                        if (options.oneofs)
                    ...
                    if (message.set_system_contract != null &&
                        ...
                        object.set_system_contract =
                            $root.koinos.protocol.set_system_contract_operation.toObject(message.set_system_contract, options);
                        if (options.oneofs)
            ...
            protocol.transaction_header = (function () {
                ...
                transaction_header.toObject = function toObject(message, options) {
                    ...
                    if (message.chain_id != null && message.hasOwnProperty("chain_id"))
                        object.chain_id =
                            options.bytes === String
                                ? $util.base64.encode(message.chain_id, 0, message.chain_id.length)
                                : options.bytes === Array
                        ...
                        if (typeof message.rc_limit === "number")
                            ...
                            object.rc_limit =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.rc_limit.low >>> 0, message.rc_limit.high >>> 0).toNumber(true)
                                        : message.rc_limit;
                    if (message.nonce != null && message.hasOwnProperty("nonce"))
                        object.nonce =
                            options.bytes === String
                    ...
                    if (message.operation_merkle_root != null &&
                        ...
                        object.operation_merkle_root =
                            options.bytes === String
                                ? $util.base64.encode(message.operation_merkle_root, 0, message.operation_merkle_root.length)
                                : options.bytes === Array
            ...
            protocol.transaction = (function () {
                ...
                transaction.encode = function encode(message, writer) {
                    ...
                    if (message.header != null &&
                        ...
                        $root.koinos.protocol.transaction_header
                            .encode(message.header, writer.uint32(/* id 2, wireType 2 =*/ 18).fork())
                            .ldelim();
                    if (message.operations != null && message.operations.length)
                        for (var i = 0; i < message.operations.length; ++i)
                            $root.koinos.protocol.operation
                                .encode(message.operations[i], writer.uint32(/* id 3, wireType 2 =*/ 26).fork())
                                .ldelim();
                ...
                transaction.verify = function verify(message) {
                    ...
                    if (message.id != null && message.hasOwnProperty("id"))
                        if (!((message.id && typeof message.id.length === "number") ||
                ...
                transaction.fromObject = function fromObject(object) {
                    ...
                    if (object.header != null) {
                        ...
                        message.header =
                            $root.koinos.protocol.transaction_header.fromObject(object.header);
                    }
                    if (object.operations) {
                        ...
                        for (var i = 0; i < object.operations.length; ++i) {
                            ...
                            message.operations[i] =
                                $root.koinos.protocol.operation.fromObject(object.operations[i]);
                        }
                    }
            ...
            protocol.transaction_receipt = (function () {
                    ...
                    if (message.events != null && message.events.length)
                        for (var i = 0; i < message.events.length; ++i)
                            $root.koinos.protocol.event_data
                                .encode(message.events[i], writer.uint32(/* id 10, wireType 2 =*/ 82).fork())
                                .ldelim();
                ...
                transaction_receipt.verify = function verify(message) {
                    ...
                    if (message.max_payer_rc != null &&
                        ...
                        if (!$util.isInteger(message.max_payer_rc) &&
                    ...
                    if (message.rc_used != null && message.hasOwnProperty("rc_used"))
                        if (!$util.isInteger(message.rc_used) &&
                            !(message.rc_used &&
                    ...
                    if (message.disk_storage_used != null &&
                        ...
                        if (!$util.isInteger(message.disk_storage_used) &&
                    ...
                    if (message.network_bandwidth_used != null &&
                        ...
                        if (!$util.isInteger(message.network_bandwidth_used) &&
                    ...
                    if (message.compute_bandwidth_used != null &&
                        ...
                        if (!$util.isInteger(message.compute_bandwidth_used) &&
                        ...
                        if (typeof message.max_payer_rc === "number")
                            ...
                            object.max_payer_rc =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.max_payer_rc.low >>> 0, message.max_payer_rc.high >>> 0).toNumber(true)
                                        : message.max_payer_rc;
                    if (message.rc_limit != null && message.hasOwnProperty("rc_limit"))
                        if (typeof message.rc_limit === "number")
                            object.rc_limit =
                        ...
                        if (typeof message.rc_used === "number")
                            ...
                            object.rc_used =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.rc_used.low >>> 0, message.rc_used.high >>> 0).toNumber(true)
                                        : message.rc_used;
                    if (message.disk_storage_used != null &&
                        message.hasOwnProperty("disk_storage_used"))
                        if (typeof message.disk_storage_used === "number")
                            ...
                            object.disk_storage_used =
                                options.longs === String
                                    ? $util.Long.prototype.toString.call(message.disk_storage_used)
                                    : options.longs === Number
                                        ? new $util.LongBits(message.disk_storage_used.low >>> 0, message.disk_storage_used.high >>> 0).toNumber(true)
                                        : message.disk_storage_used;
                    if (message.network_bandwidth_used != null &&
                        message.hasOwnProperty("network_bandwidth_used"))
                        if (typeof message.network_bandwidth_used === "number")
                            ...
                            object.network_bandwidth_used =
                                options.longs === String
                                    ? $util.Long.prototype.toString.call(message.network_bandwidth_used)
                                    : options.longs === Number
                                        ? new $util.LongBits(message.network_bandwidth_used.low >>> 0, message.network_bandwidth_used.high >>> 0).toNumber(true)
                                        : message.network_bandwidth_used;
                    if (message.compute_bandwidth_used != null &&
                        message.hasOwnProperty("compute_bandwidth_used"))
                        if (typeof message.compute_bandwidth_used === "number")
                            ...
                            object.compute_bandwidth_used =
                                options.longs === String
                                    ? $util.Long.prototype.toString.call(message.compute_bandwidth_used)
                                    : options.longs === Number
                                        ? new $util.LongBits(message.compute_bandwidth_used.low >>> 0, message.compute_bandwidth_used.high >>> 0).toNumber(true)
                                        : message.compute_bandwidth_used;
                    if (message.reverted != null && message.hasOwnProperty("reverted"))
            ...
            protocol.block_header = (function () {
                ...
                block_header.verify = function verify(message) {
                    ...
                    if (message.previous_state_merkle_root != null &&
                        ...
                        if (!((message.previous_state_merkle_root &&
                ...
                block_header.toObject = function toObject(message, options) {
                    ...
                    if (message.previous != null && message.hasOwnProperty("previous"))
                        object.previous =
                            options.bytes === String
                                ? $util.base64.encode(message.previous, 0, message.previous.length)
                                : options.bytes === Array
                    ...
                    if (message.previous_state_merkle_root != null &&
                        ...
                        object.previous_state_merkle_root =
                            options.bytes === String
                                ? $util.base64.encode(message.previous_state_merkle_root, 0, message.previous_state_merkle_root.length)
                                : options.bytes === Array
                    ...
                    if (message.transaction_merkle_root != null &&
                        ...
                        object.transaction_merkle_root =
                            options.bytes === String
                                ? $util.base64.encode(message.transaction_merkle_root, 0, message.transaction_merkle_root.length)
                                : options.bytes === Array
                    ...
                    if (message.transactions != null && message.transactions.length)
                        for (var i = 0; i < message.transactions.length; ++i)
                            $root.koinos.protocol.transaction
                                .encode(message.transactions[i], writer.uint32(/* id 3, wireType 2 =*/ 26).fork())
                                .ldelim();
                    ...
                    if (object.transactions) {
                        ...
                        for (var i = 0; i < object.transactions.length; ++i) {
                            ...
                            message.transactions[i] =
                                $root.koinos.protocol.transaction.fromObject(object.transactions[i]);
                        }
                    }
                    ...
                    if (message.transactions && message.transactions.length) {
                        ...
                        for (var j = 0; j < message.transactions.length; ++j)
                            object.transactions[j] =
                                $root.koinos.protocol.transaction.toObject(message.transactions[j], options);
                    }
                    if (message.signature != null && message.hasOwnProperty("signature"))
                        object.signature =
                            options.bytes === String
            ...
            protocol.block_receipt = (function () {
                ...
                block_receipt.encode = function encode(message, writer) {
                    ...
                    if (message.compute_bandwidth_used != null &&
                        ...
                        writer
                            .uint32(/* id 5, wireType 0 =*/ 40)
                            .uint64(message.compute_bandwidth_used);
                    if (message.state_merkle_root != null &&
                    ...
                    if (message.events != null && message.events.length)
                        for (var i = 0; i < message.events.length; ++i)
                            $root.koinos.protocol.event_data
                                .encode(message.events[i], writer.uint32(/* id 7, wireType 2 =*/ 58).fork())
                                .ldelim();
                    if (message.transaction_receipts != null &&
                        ...
                        for (var i = 0; i < message.transaction_receipts.length; ++i)
                            $root.koinos.protocol.transaction_receipt
                                .encode(message.transaction_receipts[i], writer.uint32(/* id 8, wireType 2 =*/ 66).fork())
                                .ldelim();
                    if (message.logs != null && message.logs.length)
                        for (var i = 0; i < message.logs.length; ++i)
                    ...
                    if (object.transaction_receipts) {
                        ...
                        for (var i = 0; i < object.transaction_receipts.length; ++i) {
                            ...
                            message.transaction_receipts[i] =
                                $root.koinos.protocol.transaction_receipt.fromObject(object.transaction_receipts[i]);
                        }
                    }
                    if (object.logs) {
                        if (!Array.isArray(object.logs))
                ...
                block_receipt.toObject = function toObject(message, options) {
                    ...
                    if (message.state_merkle_root != null &&
                        ...
                        object.state_merkle_root =
                            options.bytes === String
                                ? $util.base64.encode(message.state_merkle_root, 0, message.state_merkle_root.length)
                                : options.bytes === Array
                    ...
                    if (message.transaction_receipts &&
                        ...
                        for (var j = 0; j < message.transaction_receipts.length; ++j)
                            object.transaction_receipts[j] =
                                $root.koinos.protocol.transaction_receipt.toObject(message.transaction_receipts[j], options);
                    }
                    if (message.logs && message.logs.length) {
                        object.logs = [];
                        for (var j = 0; j < message.logs.length; ++j)
            ...
            chain.value_type = (function () {
                ...
                value_type.verify = function verify(message) {
                    ...
                    if (message.int64_value != null &&
                        ...
                        if (properties.kind === 1)
                            return "kind: multiple values";
                        properties.kind = 1;
                        if (!$util.isInteger(message.int64_value) &&
                            !(message.int64_value &&
                    ...
                    if (message.uint64_value != null &&
                        ...
                        if (properties.kind === 1)
                            return "kind: multiple values";
                        properties.kind = 1;
                        if (!$util.isInteger(message.uint64_value) &&
                    ...
                    if (message.sint64_value != null &&
                        ...
                        if (properties.kind === 1)
                            return "kind: multiple values";
                        properties.kind = 1;
                        if (!$util.isInteger(message.sint64_value) &&
                    ...
                    if (message.fixed64_value != null &&
                        ...
                        if (properties.kind === 1)
                            return "kind: multiple values";
                        properties.kind = 1;
                        if (!$util.isInteger(message.fixed64_value) &&
                    ...
                    if (message.sfixed64_value != null &&
                        ...
                        if (properties.kind === 1)
                            return "kind: multiple values";
                        properties.kind = 1;
                        if (!$util.isInteger(message.sfixed64_value) &&
                ...
                value_type.toObject = function toObject(message, options) {
                        ...
                        if (typeof message.int64_value === "number")
                            ...
                            object.int64_value =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.int64_value.low >>> 0, message.int64_value.high >>> 0).toNumber()
                                        : message.int64_value;
                        if (options.oneofs)
                        ...
                        if (typeof message.uint64_value === "number")
                            ...
                            object.uint64_value =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.uint64_value.low >>> 0, message.uint64_value.high >>> 0).toNumber(true)
                                        : message.uint64_value;
                        if (options.oneofs)
                        ...
                        if (typeof message.sint64_value === "number")
                            ...
                            object.sint64_value =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.sint64_value.low >>> 0, message.sint64_value.high >>> 0).toNumber()
                                        : message.sint64_value;
                        if (options.oneofs)
                        ...
                        if (typeof message.fixed64_value === "number")
                            ...
                            object.fixed64_value =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.fixed64_value.low >>> 0, message.fixed64_value.high >>> 0).toNumber()
                                        : message.fixed64_value;
                        if (options.oneofs)
                        ...
                        if (typeof message.sfixed64_value === "number")
                            ...
                            object.sfixed64_value =
                                options.longs === String
                                    ...
                                    : options.longs === Number
                                        ? new $util.LongBits(message.sfixed64_value.low >>> 0, message.sfixed64_value.high >>> 0).toNumber()
                                        : message.sfixed64_value;
                        if (options.oneofs)
                    ...
                    if (message.bytes_value != null &&
                        ...
                        object.bytes_value =
                            options.bytes === String
                                ? $util.base64.encode(message.bytes_value, 0, message.bytes_value.length)
                                : options.bytes === Array
                    ...
                    if (message.values != null && message.values.length)
                        for (var i = 0; i < message.values.length; ++i)
                            $root.koinos.chain.value_type
                                .encode(message.values[i], writer.uint32(/* id 1, wireType 2 =*/ 10).fork())
                                .ldelim();
                    return writer;
                };
                /**
...
//# sourceMappingURL=protocol-proto.js.map
...
const token_proto_json_1 = __importDefault(__webpack_require__(2077));
/**
...
const Serializer_1 = __webpack_require__(5919);
const utils_1 = __webpack_require__(7956);
const chain_proto_json_1 = __importDefault(__webpack_require__(3443));
const defaultAlias = {
    ...
    return {
        ...
        prepareTransaction: async (transaction) => {
            if (options && options.providerPrepareTransaction) {
                const signer = koilib_1.Signer.fromSeed("seed");
