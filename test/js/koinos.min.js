  ...
  var __webpack_modules__ = {
      8820: (e) => {
        ...
        e.exports = function (e) {
          ...
          function u(e) {
            ...
            var r = 0;
            if (" " !== e[r]) {
              for (var n = 0, o = 0; e[r] === a; ) n++, r++;
              for (
                var i = ((e.length - r) * l + 1) >>> 0, c = new Uint8Array(i);
                e[r];
              ...
              if (" " !== e[r]) {
                for (var f = i - o; f !== i && 0 === c[f]; ) f++;
                for (var h = new Uint8Array(n + (i - f)), y = n; f !== i; )
                  h[y++] = c[f++];
                return h;
              }
            }
          ...
          return {
            encode: function (t) {
              ...
              for (
                var r = 0, n = 0, o = 0, i = t.length;
                o !== i && 0 === t[o];

              )
                o++, r++;
              for (
                var l = ((i - o) * c + 1) >>> 0, u = new Uint8Array(l);
                o !== i;
              ...
              for (var h = l - n; h !== l && 0 === u[h]; ) h++;
              for (var y = a.repeat(r); h < l; ++h) y += e.charAt(u[h]);
              return y;
            },
            decodeUnsafe: u,
            decode: function (e) {
      ...
      7505: (e, t, r) => {
        ...
        class o extends n.Hash {
          ...
          update(e) {
            ...
            const { view: t, buffer: r, blockLen: o, finished: i } = this;
            ...
            for (let i = 0; i < s; ) {
              ...
              if (a !== o)
                ...
                for (; o <= s - i; i += o) this.process(t, i);
              }
            }
          ...
          digestInto(e) {
            ...
            !(function (e, t, r, n) {
              ...
              const o = BigInt(32),
                ...
                l = n ? 4 : 0,
                c = n ? 0 : 4;
              e.setUint32(t + l, s, n), e.setUint32(t + c, a, n);
            })(r, o - 8, BigInt(8 * this.length), i),
              this.process(r, 0);
            const a = (0, n.createView)(e);
            this.get().forEach((e, t) => a.setUint32(4 * t, e, i));
          }
          digest() {
      ...
      830: (e, t, r) => {
        ...
        let l = [s],
          c = [a];
        for (let e = 0; e < 4; e++)
          for (let t of [l, c]) t.push(t[e].map((e) => i[e]));
        const u = [
          ...
          process(e, t) {
            ...
            for (let e = 0; e < 5; e++) {
              const t = 4 - e,
                ...
                j = p[e];
              for (let t = 0; t < 16; t++) {
                const n = (y(r + _(e, o, s, u) + g[O[t]] + w, S[t]) + m) | 0;
                (r = m), (m = u), (u = 0 | y(s, 10)), (s = o), (o = n);
              }
              for (let e = 0; e < 16; e++) {
                const r = (y(n + _(t, i, a, b) + g[x[e]] + k, j[e]) + v) | 0;
                (n = v), (v = b), (b = 0 | y(a, 10)), (a = i), (i = r);
              }
            }
            this.set(
              (this.h1 + s + b) | 0,
        ...
        (t.RIPEMD160 = b),
          (t.ripemd160 = (0, o.wrapConstructor)(() => new b()));
      },
      3061: (e, t, r) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        class c extends n.SHA2 {
          ...
          process(e, t) {
            ...
            let { A: r, B: n, C: a, D: c, E: u, F: d, G: p, H: f } = this;
            for (let e = 0; e < 64; e++) {
              const t =
                  (f +
                    ((0, o.rotr)(u, 6) ^
        ...
        t.sha256 = (0, o.wrapConstructor)(() => new c());
      },
      8089: (e, t, r) => {
        "use strict";
        (e = r.nmd(e)),
        ...
        function s(e) {
          if (("string" == typeof e && (e = i(e)), !(e instanceof Uint8Array)))
            throw new TypeError(
        ...
        (t.bytesToHex = function (e) {
          ...
          (t.hexToBytes = function (e) {
            ...
            for (let r = 0; r < t.length; r++) {
              ...
              if (Number.isNaN(i)) throw new Error("Invalid byte sequence");
              t[r] = i;
            }
            return t;
          }),
      ...
      9656: function (e, t, r) {
        ...
        class h {
          ...
          equals(e) {
            const t = this,
              ...
              i = N(r.z * r.z),
              s = N(r.z * i);
            return N(t.x * i) === N(n * r.x) && N(t.y * s) === N(o * r.y);
          }
          negate() {
            return new h(this.x, N(-this.y), this.z);
          }
          double() {
            const e = this.x,
              t = this.y,
          ...
          add(e) {
            ...
            const c = N(n ** a),
              ...
              _ = N(p - d),
              g = N(y - f);
            if (_ === i) return g === i ? this.double() : h.ZERO;
            const b = N(_ ** a),
              m = N(_ * b),
              v = N(d * b),
              w = N(g ** a - m - a * v),
          ...
          multiplyUnsafe(e) {
            ...
            let { k1neg: r, k1: n, k2neg: o, k2: a } = R(t),
              l = h.ZERO,
              c = h.ZERO,
              u = this;
            for (; n > i || a > i; )
            ...
            return (
              r && (l = l.negate()),
              o && (c = c.negate()),
              (c = new h(N(c.x * d.beta), c.y, c.z)),
              l.add(c)
            );
          }
          precomputeWindow(e) {
            const t = f ? 128 / e + 1 : 256 / e + 1,
              r = [];
            let n = this,
              o = n;
            for (let i = 0; i < t; i++) {
          ...
          wNAF(e, t) {
            ...
            n ||
              ...
              t && 1 !== r && ((n = h.normalizeZ(n)), y.set(t, n)));
            let o = h.ZERO,
              i = h.ZERO;
            const a = f ? 128 / r + 1 : 256 / r + 1,
              l = 2 ** (r - 1),
              c = BigInt(2 ** r - 1),
              u = 2 ** r,
              d = BigInt(r);
            for (let t = 0; t < a; t++) {
              const r = t * l;
              let a = Number(e & c);
              if (((e >>= d), a > l && ((a -= u), (e += s)), 0 === a)) {
                let e = n[r];
                t % 2 && (e = e.negate()), (i = i.add(e));
              } else {
                let e = n[r + Math.abs(a) - 1];
                a < 0 && (e = e.negate()), (o = o.add(e));
              }
            }
            return { p: o, f: i };
          }
          multiply(e, t) {
            let r,
              ...
              o = P(e);
            if (f) {
              let { k1neg: e, k1: i, k2neg: s, k2: a } = R(o),
                { p: l, f: c } = this.wNAF(i, t),
                { p: u, f: p } = this.wNAF(a, t);
              e && (l = l.negate()),
                s && (u = u.negate()),
                (u = new h(N(u.x * d.beta), u.y, u.z)),
                (r = l.add(u)),
                (n = c.add(p));
            } else {
        ...
        (h.BASE = new h(d.Gx, d.Gy, s)), (h.ZERO = new h(i, s, i));
        const y = new WeakMap();
        class _ {
          constructor(e, t) {
            (this.x = e), (this.y = t);
          ...
          static fromCompressedHex(e) {
            ...
            const o = (n & s) === s;
            t ? o && (n = N(-n)) : (1 == (1 & e[0])) !== o && (n = N(-n));
            const i = new _(r, n);
            return i.assertValidity(), i;
          }
          static fromUncompressedHex(e) {
            const t = E(e.slice(1, 33)),
              r = E(e.slice(33)),
              n = new _(t, r);
          ...
          static fromPrivateKey(e) {
            return _.BASE.multiply($(e));
          }
          static fromSignature(e, t, r) {
            let n = e instanceof Uint8Array ? E(e) : j(e);
            const o = M(t),
              { r: i, s } = o;
            if (0 !== r && 1 !== r)
            ...
            const a = 2 + (1 & r),
              l = _.fromHex(`0${a}${O(i)}`),
              c = h.fromAffine(l).multiplyUnsafe(s),
              u = h.BASE.multiply(n),
              p = I(i, d.n),
              f = c.subtract(u).multiplyUnsafe(p).toAffine();
            return f.assertValidity(), f;
          }
          toRawBytes(e = !1) {
            return A(this.toHex(e));
          }
          toHex(e = !1) {
            const t = O(this.x);
          ...
          assertValidity() {
            const e = "Point is not on elliptic curve",
              { x: t, y: r } = this;
            if (!C(t) || !C(r)) throw new Error(e);
            const n = N(r * r);
            if (N(n - p(t)) !== i) throw new Error(e);
          }
          equals(e) {
            return this.x === e.x && this.y === e.y;
          }
          negate() {
            return new _(this.x, N(-this.y));
          }
          double() {
        ...
        function b(e) {
          if (e.length < 2 || 2 !== e[0])
            throw new Error(`Invalid signature integer tag: ${k(e)}`);
          const t = e[1],
            r = e.subarray(2, t + 2);
          if (!t || r.length !== t)
          ...
          return { data: E(r), left: e.subarray(t + 2) };
        }
        (t.Point = _), (_.BASE = new _(d.Gx, d.Gy)), (_.ZERO = new _(i, i));
        class m {
          constructor(e, t) {
          ...
          static fromCompact(e) {
            ...
            return new m(j(n.slice(0, 64)), j(n.slice(64, 128)));
          }
          static fromDER(e) {
            const t = e instanceof Uint8Array;
            if ("string" != typeof e && !t)
            ...
            const { r, s: n } = (function (e) {
              if (e.length < 2 || 48 != e[0])
                throw new Error(`Invalid signature tag: ${k(e)}`);
              if (e[1] !== e.length - 2)
                throw new Error("Invalid signature: incorrect length");
              const { data: t, left: r } = b(e.subarray(2)),
                { data: n, left: o } = b(r);
              if (o.length)
                throw new Error(
                  `Invalid signature: left bytes after parsing: ${k(o)}`
                );
              return { r: t, s: n };
            })(t ? e : A(e));
            return new m(r, n);
          ...
          normalizeS() {
            return this.hasHighS() ? new m(this.r, d.n - this.s) : this;
          }
          toDERRawBytes(e = !1) {
            return A(this.toDERHex(e));
          }
          toDERHex(e = !1) {
            const t = g(S(this.s));
            if (e) return t;
        ...
        t.Signature = m;
        const w = Array.from({ length: 256 }, (e, t) =>
          t.toString(16).padStart(2, "0")
        );
        function k(e) {
          let t = "";
          for (let r = 0; r < e.length; r++) t += w[e[r]];
          return t;
        }
        function O(e) {
          if (e > u) throw new Error("pad64: invalid number");
        ...
        function B(e) {
          return e instanceof Uint8Array ? e : A(e);
        }
        function E(e) {
        ...
        function P(e) {
          if ("number" == typeof e && e > 0 && Number.isSafeInteger(e))
            return BigInt(e);
          if ("bigint" == typeof e && z(e)) return e;
          throw new TypeError(
        ...
        function R(e) {
          ...
          const p = c > D,
            f = u > D;
          if ((p && (c = t - c), f && (u = t - u), c > D || u > D))
            throw new Error("splitScalarEndo: Endomorphism failed");
          return { k1neg: p, k1: c, k2neg: f, k2: u };
        }
        class U {
          constructor() {
        ...
        function J(e, t, r) {
          ...
          const { n: o } = d,
            ...
            l = N(a.x, o);
          if (l === i) return;
          const c = N(I(n, o) * N(t + r * l, o), o);
          if (c === i) return;
          const u = new m(l, c);
          return { sig: u, recovery: (a.x === u.r ? 0 : 2) | Number(a.y & s) };
        }
        function $(e) {
          let t;
          ...
          if (!z(t)) throw new Error("Expected private key: 0 < key < n");
          return t;
        }
        function H(e) {
          return e instanceof _ ? (e.assertValidity(), e) : _.fromHex(e);
        }
        function M(e) {
        ...
        function F(e) {
          return E(e.length > 32 ? e.slice(0, 32) : e);
        }
        function V(e) {
          const t = F(e),
            r = N(t, d.n);
        ...
        function W(e, t) {
          ...
          o && r.hasHighS() && ((r = r.normalizeS()), (n ^= 1));
          const a = i ? r.toDERRawBytes() : r.toCompactRawBytes();
          return s ? [a, n] : a;
        }
        (t.getPublicKey = function (e, t = !1) {
          ...
          (t.recoverPublicKey = function (e, t, r) {
            return _.fromSignature(e, t, r).toRawBytes();
          }),
          ...
          (t.sign = async function (e, t, r = {}) {
            const { seed: n, m: o, d: i } = G(e, t, r.extraEntropy);
            let s;
            const a = new U();
            for (await a.reseed(n); !(s = J(await a.generate(), o, i)); )
              await a.reseed();
            return W(s, r);
          }),
          (t.signSync = function (e, t, r = {}) {
            ...
            let s;
            const a = new U();
            for (a.reseedSync(n); !(s = J(a.generateSync(), o, i)); )
              a.reseedSync();
            return W(s, r);
          });
        const Z = { strict: !0 };
        async function X(e, ...r) {
          const n = new Uint8Array(e.split("").map((e) => e.charCodeAt(0))),
            o = await t.utils.sha256(n);
          return E(await t.utils.sha256(v(o, o, ...r)));
        }
        async function Q(e, t, r) {
          const n = x(e);
          return N(await X("BIP0340/challenge", n, t.toRawX(), r), d.n);
        }
        function Y(e) {
          return N(e.y, a) === i;
        }
        t.verify = function (e, t, r, n = Z) {
          ...
          const l = (function (e) {
            ...
            return r > 0 && (t >>= BigInt(r)), t >= d.n && (t -= d.n), t;
          })(t);
          if (l === i) return !1;
          let c;
          try {
          ...
          const { n: u } = d,
            ...
            y = N(s * p, u),
            _ = h.BASE.multiply(f),
            g = c.multiplyUnsafe(y);
          return N(_.add(g).toAffine().x, u) === s;
        };
        class ee {
          constructor(e, t) {
            if (((this.r = e), (this.s = t), !C(e) || !z(t)))
        ...
        async function te(e, t, r) {
          const n = e instanceof ee ? e : ee.fromHex(e),
            ...
            i = H(r),
            s = await Q(n.r, i, o),
            a = _.fromPrivateKey(n.s),
            l = i.multiply(s),
            c = a.subtract(l);
          return !(c.equals(_.BASE) || !Y(c) || c.x !== n.r);
        }
        (t.schnorr = {
          Signature: ee,
          getPublicKey: function (e) {
            return _.fromPrivateKey(e).toRawX();
          },
          sign: async function (e, r, n = t.utils.randomBytes()) {
            ...
            const c = _.fromPrivateKey(a),
              u = Y(c) ? a : o - a,
              p = u ^ (await X("BIP0340/aux", l)),
              f = N(await X("BIP0340/nonce", x(p), c.toRawX(), s), o);
            if (f === i)
              throw new Error("sign: Creation of signature failed. k is zero");
            const h = _.fromPrivateKey(f),
              y = Y(h) ? f : o - f,
              g = await Q(h.x, c, s),
              b = new ee(h.x, N(y + g * u, o));
            if (!(await te(b.toRawBytes(), s, c.toRawX())))
        ...
        t.utils = {
          ...
          hmacSha256: async (e, ...t) => {
            if (re.web) {
              const r = await re.web.subtle.importKey(
                ...
                n = v(...t),
                o = await re.web.subtle.sign("HMAC", r, n);
          ...
          precompute(e = 8, t = _.BASE) {
            const r = t === _.BASE ? t : new _(t.x, t.y);
      ...
      4537: (e) => {
        ...
        e.exports = function (e, t) {
          for (
            var r = new Array(arguments.length - 1), n = 0, o = 2, i = !0;
            o < arguments.length;
      ...
      7419: (e, t) => {
        ...
        r.encode = function (e, t, r) {
          for (var o, i = null, s = [], a = 0, l = 0; t < r; ) {
            var c = e[t++];
            switch (l) {
              case 0:
                (s[a++] = n[c >> 2]), (o = (3 & c) << 4), (l = 1);
                break;
              case 1:
                (s[a++] = n[o | (c >> 4)]), (o = (15 & c) << 2), (l = 2);
                break;
              case 2:
                (s[a++] = n[o | (c >> 6)]), (s[a++] = n[63 & c]), (l = 0);
            }
            a > 8191 &&
        ...
        (r.decode = function (e, t, r) {
          for (var n, i = r, a = 0, l = 0; l < e.length; ) {
            ...
            switch (a) {
              case 0:
                ...
                break;
              case 1:
                (t[r++] = (n << 2) | ((48 & c) >> 4)), (n = c), (a = 2);
                break;
              case 2:
                (t[r++] = ((15 & n) << 4) | ((60 & c) >> 2)), (n = c), (a = 3);
                break;
              case 3:
                (t[r++] = ((3 & n) << 6) | c), (a = 0);
            }
            ...
            if ("string" != typeof e) {
              ...
              if (
                ...
                for (
                  ...
                  (a[c] = s[c]), (l[c] = e[s[c++]]);
                return (a[c] = r), Function.apply(null, a).apply(null, l);
              }
              return Function(r)();
            }
              ...
              : (function () {
                  function t(e, t, r, n) {
                    ...
                    if ((o && (t = -t), 0 === t))
                      ...
                      e(
                        ((o << 31) | Math.round(t / 1401298464324817e-60)) >>>
                          0,
                        r,
                        n
                      );
              ...
              : (function () {
                  function t(e, t, r, n, o, i) {
                    ...
                    if ((s && (n = -n), 0 === n))
                      ...
                      if (n < 22250738585072014e-324)
                        ...
                        1024 === l && (l = 1023),
                          e(
                            (4503599627370496 * (a = n * Math.pow(2, -l))) >>>
                              0,
                            o,
                            i + t
                          ),
                  ...
                  function s(e, t, r, n, o) {
                    ...
                    return 2047 === l
                      ...
                      : 0 === l
                      ? 5e-324 * a * c
                      : a * Math.pow(2, l - 1075) * (c + 4503599627370496);
                  }
      ...
      5077: (e, t, r) => {
        ...
        const n = r(8820),
          ...
          c = l.reduce(
            (e, t) => ((e[t[0]] = new o(t[0], t[1], t[2], t[3])), e),
            {}
          ),
          u = l.reduce((e, t) => ((e[t[1]] = c[t[0]]), e), {});
        e.exports = { names: c, codes: u };
      },
      6957: (e, t, r) => {
        "use strict";
        const n = r(5077),
          { encodeText: o, decodeText: i, concat: s } = r(2413);
        function a(e) {
        ...
        const l = Object.freeze(n.names),
          c = Object.freeze(n.codes);
        (t.names = l), (t.codes = c);
      },
      6727: (e) => {
        "use strict";
          ...
          rfc4648: (e) => (t) => ({
            ...
            decode: (r) =>
              ((e, t, r) => {
                ...
                let o = e.length;
                for (; "=" === e[o - 1]; ) --o;
                const i = new Uint8Array(((o * r) / 8) | 0);
                let s = 0,
                  a = 0,
                  l = 0;
                for (let t = 0; t < o; ++t) {
        ...
        (n.fromObject = function (e) {
          ...
          for (var n = 0; n < t.length; ++n) {
            var a = t[n].resolve(),
              l = i.safeProp(a.name);
            a.map
              ? (r("if(d%s){", l)('if(typeof d%s!=="object")', l)(
                  "throw TypeError(%j)",
                ...
                s(r, a, n, l + "[ks[i]]")("}")("}"))
              : a.repeated
              ? (r("if(d%s){", l)("if(!Array.isArray(d%s))", l)(
                  "throw TypeError(%j)",
                  a.fullName + ": array expected"
                )("m%s=[]", l)("for(var i=0;i<d%s.length;++i){", l),
                s(r, a, n, l + "[i]")("}")("}"))
              : (a.resolvedType instanceof o || r("if(d%s!=null){", l),
                s(r, a, n, l),
          ...
          (n.toObject = function (e) {
            ...
            for (
              var r = i.codegen(["m", "o"], e.name + "$toObject")("if(!o)")(
                  "o={}"
                )("var d={}"),
                n = [],
                s = [],
              ...
              t[c].partOf ||
                (t[c].resolve().repeated ? n : t[c].map ? s : l).push(t[c]);
            if (n.length) {
            ...
            if (l.length) {
              for (r("if(o.defaults){"), c = 0; c < l.length; ++c) {
                var u = l[c],
                  d = i.safeProp(u.name);
                if (u.resolvedType instanceof o)
                  r(
              ...
              (d = i.safeProp(u.name)),
                u.map
                  ? (f || ((f = !0), r("var ks2")),
                    ...
                    a(r, u, h, d + "[ks2[j]]")("}"))
                  : u.repeated
                  ? (r("if(m%s&&m%s.length){", d, d)("d%s=[]", d)(
                      "for(var j=0;j<m%s.length;++j){",
                      d
                    ),
                    a(r, u, h, d + "[j]")("}"))
                  : (r("if(m%s!=null&&m.hasOwnProperty(%j)){", d, u.name),
                    a(r, u, h, d),
                    u.partOf &&
                      r("if(o.oneofs)")(
                        "d%s=%j",
                        i.safeProp(u.partOf.name),
                        u.name
                      )),
                r("}");
            }
        ...
        e.exports = function (e) {
          ...
          for (var r = 0; r < e.fieldsArray.length; ++r) {
            var a = e._fieldsArray[r].resolve(),
              l = a.resolvedType instanceof n ? "int32" : a.type,
              c = "m" + i.safeProp(a.name);
            t("case %i:", a.id),
              a.map
                ? (t("if(%s===util.emptyObject)", c)("%s={}", c)(
                    "var c2 = r.uint32()+r.pos"
                  ),
                  void 0 !== o.defaults[a.keyType]
                    ? t("k=%j", o.defaults[a.keyType])
                    : t("k=null"),
                  void 0 !== o.defaults[l]
                    ? t("value=%j", o.defaults[l])
                    : t("value=null"),
        ...
        e.exports = function (e) {
          for (
            ...
            var c = a[l].resolve(),
              ...
              d = c.resolvedType instanceof n ? "int32" : c.type,
              p = o.basic[d];
              ...
              c.map
                ? (r(
                  ...
                  void 0 === p
                    ...
                    : r(".uint32(%i).%s(%s[ks[i]]).ldelim()", 16 | p, d, t),
                  r("}")("}"))
                : c.repeated
                ? (r("if(%s!=null&&%s.length){", t, t),
                  c.packed && void 0 !== o.packed[d]
                ...
                : (c.optional &&
                  ...
                  void 0 === p
                    ? s(r, c, u, t)
                    : r("w.uint32(%i).%s(%s)", ((c.id << 3) | p) >>> 0, d, t));
          }
          return r("return w");
        };
        var n = r(7025),
      ...
      3548: (e, t, r) => {
        ...
        function c(e, t, r, o, i, c, u) {
          if (
            (a.isObject(o)
              ? ((u = i), (c = o), (o = i = void 0))
              : a.isObject(i) && ((u = c), (c = i), (i = void 0)),
            n.call(this, e, c),
            !a.isInteger(t) || t < 0)
          )
            throw TypeError("id must be a non-negative integer");
          if (!a.isString(r)) throw TypeError("type must be a string");
          if (void 0 !== o && !l.test((o = o.toString().toLowerCase())))
      ...
      4429: (e, t, r) => {
        ...
        ((i.prototype = Object.create(n.prototype)).constructor = i).className =
          "Method";
        var o = r(9935);
        function i(e, t, r, i, s, a, l, c, u) {
          if (
            (o.isObject(s)
              ? ((l = s), (s = a = void 0))
              : o.isObject(a) && ((l = a), (a = void 0)),
      ...
      9313: (e, t, r) => {
        ...
        e.exports = d;
        var n = r(3243);
        ((d.prototype = Object.create(n.prototype)).constructor = d).className =
          "Namespace";
        var o,
          i,
          s,
        ...
        (d.fromJSON = function (e, t) {
          ...
          Object.defineProperty(d.prototype, "nestedArray", {
            get: function () {
              return (
                this._nestedArray ||
                (this._nestedArray = c.toArray(this.nested))
              );
            },
          }),
          ...
          (i.prototype.setParsedOption = function (e, t, r) {
            ...
            if (r) {
              ...
              if (i) {
                var s = i[e];
                o.setProperty(s, r, t);
              } else ((i = {})[e] = o.setProperty({}, r, t)), n.push(i);
            } else {
              var a = {};
              (a[e] = t), n.push(a);
            }
            ...
            return o.Buffer
              ? function (e) {
                  return (l.create = function (e) {
                    return o.Buffer.isBuffer(e) ? new n(e) : u(e);
                  })(e);
                }
              : u;
          };
      ...
      9424: (e, t, r) => {
        ...
        (d.fromJSON = function (e, t) {
          ...
          (d.prototype.load = function e(t, r, n) {
            ...
            var o = this;
            if (!n) return u.asPromise(e, o, t, r);
            var a = n === p;
            function l(e, t) {
              if (n) {
                var r = n;
                ...
                if (
                  ...
                  if (s.imports)
                    for (; d < s.imports.length; ++d)
                      (n = c(s.imports[d]) || o.resolvePath(e, s.imports[d])) &&
                        f(n);
                  if (s.weakImports)
                    for (d = 0; d < s.weakImports.length; ++d)
                      (n =
                        c(s.weakImports[d]) ||
                        o.resolvePath(e, s.weakImports[d])) && f(n, !0);
            ...
            function f(e, t) {
              if (!(o.files.indexOf(e) > -1))
                if ((o.files.push(e), e in s))
                  ...
                  ++h,
                    o.fetch(e, function (r, i) {
                      --h, n && (r ? (t ? h || l(null, o) : l(r)) : d(e, i));
                    });
            }
            var h = 0;
            u.isString(t) && (t = [t]);
            for (var y, _ = 0; _ < t.length; ++_)
              (y = o.resolvePath("", t[_])) && f(y);
            if (a) return o;
            h || l(null, o);
          }),
      ...
      7948: (e, t, r) => {
        ...
        ((o.prototype = Object.create(n.EventEmitter.prototype)).constructor =
          o),
        ...
        (a.fromJSON = function (e, t) {
          ...
          Object.defineProperty(a.prototype, "methodsArray", {
            get: function () {
              return (
                this._methodsArray ||
                (this._methodsArray = i.toArray(this.methods))
              );
            },
          }),
      ...
      7645: (e, t, r) => {
        ...
        e.exports = b;
        var n = r(9313);
        ((b.prototype = Object.create(n.prototype)).constructor = b).className =
          "Type";
        var o = r(7025),
          i = r(7598),
          s = r(3548),
        ...
        Object.defineProperties(b.prototype, {
          ...
          (b.generateConstructor = function (e) {
            for (
              var t, r = p.codegen(["p"], e.name), n = 0;
          ...
          (b.fromJSON = function (e, t) {
            var r = new b(e, t.options);
            (r.extensions = t.extensions), (r.reserved = t.reserved);
            for (var c = Object.keys(t.fields), u = 0; u < c.length; ++u)
              r.add(
                (void 0 !== t.fields[c[u]].keyType ? a.fromJSON : s.fromJSON)(
                  c[u],
                  t.fields[c[u]]
                )
              );
            if (t.oneofs)
              for (c = Object.keys(t.oneofs), u = 0; u < c.length; ++u)
                r.add(i.fromJSON(c[u], t.oneofs[c[u]]));
            if (t.nested)
          ...
          (b.prototype.setup = function () {
            ...
            (this.encode = f(this)({ Writer: d, types: t, util: p })),
              (this.decode = h(this)({ Reader: u, types: t, util: p })),
              (this.verify = y(this)({ types: t, util: p })),
              (this.fromObject = _.fromObject(this)({ types: t, util: p })),
              (this.toObject = _.toObject(this)({ types: t, util: p }));
            var n = g[e];
            if (n) {
      ...
      4497: (e, t, r) => {
        ...
        e.exports = function (e) {
          ...
          for (var n = 0; n < e.fieldsArray.length; ++n) {
            ...
            if (
              (l.optional &&
                t("if(%s!=null&&m.hasOwnProperty(%j)){", c, l.name),
              l.map)
            )
              t("if(!util.isObject(%s))", c)("return%j", i(l, "object"))(
                "var k=Object.keys(%s)",
                c
              ...
              t("if(!Array.isArray(%s))", c)("return%j", i(l, "array"))(
                "for(var i=0;i<%s.length;++i){",
                c
              ),
                s(t, l, n, c + "[i]")("}");
              ...
              if (l.partOf) {
                var u = o.safeProp(l.partOf.name);
                1 === r[l.partOf.name] &&
                  t("if(p%s===1)", u)(
                    "return%j",
      ...
      1173: (e, t, r) => {
        ...
        (d.create = p()),
          ...
          o.Array !== Array &&
            (d.alloc = o.pool(d.alloc, o.Array.prototype.subarray)),
          (d.prototype._push = function (e, t, r) {
            return (
              (this.tail = this.tail.next = new l(e, t, r)),
              (this.len += t),
              this
            );
          }),
      ...
      9822: (e, t, r) => {
        ...
        class i {
          constructor(e) {
            var t;
            e.id && (this.id = (0, o.decodeBase58)(e.id)),
              ...
              this.signer &&
                ...
                Object.keys(this.abi.methods).forEach((e) => {
                  this.functions[e] = async (t = {}, r) => {
                    ...
                    let u;
                    u = "function" == typeof l ? l(t) : t;
                    const d = await this.encodeOperation({ name: e, args: u });
                    if (i) {
                      ...
                      return (
                        ...
                        "function" == typeof c && (r = c(r)),
                        { operation: d, result: r }
                      );
                    }
                    if (!this.signer) throw new Error("signer not found");
                    const p = await this.signer.prepareTransaction({
                        header: {
                          ...((null == n ? void 0 : n.chainId) && {
                            chain_id: null == n ? void 0 : n.chainId,
                          }),
                          ...((null == n ? void 0 : n.rcLimit) && {
                            rc_limit: null == n ? void 0 : n.rcLimit,
                          }),
                          ...((null == n ? void 0 : n.nonce) && {
                            nonce: null == n ? void 0 : n.nonce,
                          }),
                          ...((null == n ? void 0 : n.payer) && {
                            payer: null == n ? void 0 : n.payer,
                          }),
                          ...((null == n ? void 0 : n.payee) && {
                            payee: null == n ? void 0 : n.payee,
                          }),
                        },
                        operations: [d],
                      }),
                    ...
                    if (
                      ((null == n ? void 0 : n.sendAbis) &&
                        (f[(0, o.encodeBase58)(this.id)] = this.abi),
                      !(null == n ? void 0 : n.sendTransaction))
                    ) {
                      const e = () => {
                      ...
                      return (
                        n.signTransaction &&
                          (await this.signer.signTransaction(p, f)),
                        { operation: d, transaction: { ...p, wait: e } }
                      );
                    }
                    const { transaction: h, receipt: y } =
                      await this.signer.sendTransaction(p, f);
                    return { operation: d, transaction: h, receipt: y };
                  };
                });
          }
          getId() {
            if (!this.id) throw new Error("id is not defined");
            return (0, o.encodeBase58)(this.id);
          }
          async deploy(e) {
            if (!this.signer) throw new Error("signer not found");
            ...
            const t = { ...this.options, ...e },
              r = {
                upload_contract: {
                  contract_id: (0, o.decodeBase58)(this.signer.getAddress()),
                  bytecode: this.bytecode,
                },
              },
              n = await this.signer.prepareTransaction({
                header: {
                  ...((null == t ? void 0 : t.chainId) && {
                    chain_id: null == t ? void 0 : t.chainId,
                  }),
                  ...((null == t ? void 0 : t.rcLimit) && {
                    rc_limit: null == t ? void 0 : t.rcLimit,
                  }),
                  ...((null == t ? void 0 : t.nonce) && {
                    nonce: null == t ? void 0 : t.nonce,
                  }),
                  ...((null == t ? void 0 : t.payer) && {
                    payer: null == t ? void 0 : t.payer,
                  }),
                  ...((null == t ? void 0 : t.payee) && {
                    payee: null == t ? void 0 : t.payee,
                  }),
                },
                operations: [
                  {
                    upload_contract: {
                      contract_id: (0, o.encodeBase58)(
                        r.upload_contract.contract_id
                      ),
                      bytecode: (0, o.encodeBase64url)(this.bytecode),
                      ...((null == t ? void 0 : t.abi) && {
                        abi: null == t ? void 0 : t.abi,
                      }),
                      ...((null == t ? void 0 : t.authorizesCallContract) && {
                        authorizes_call_contract:
                          null == t ? void 0 : t.authorizesCallContract,
                      }),
                      ...((null == t
                        ? void 0
                        : t.authorizesTransactionApplication) && {
                        authorizes_transaction_application:
                          null == t
                            ? void 0
                            : t.authorizesTransactionApplication,
                      }),
                      ...((null == t ? void 0 : t.authorizesUploadContract) && {
            ...
            if (!(null == t ? void 0 : t.sendTransaction)) {
              ...
              return (
                t.signTransaction && (await this.signer.signTransaction(n)),
                { operation: r, transaction: { ...n, wait: e } }
              );
            }
            const { transaction: i, receipt: s } =
              await this.signer.sendTransaction(n);
            return { operation: r, transaction: i, receipt: s };
          }
          async encodeOperation(e) {
            ...
            return {
              call_contract: {
                contract_id: (0, o.encodeBase58)(this.id),
                entry_point: t.entryPoint,
                args: (0, o.encodeBase64url)(r),
              },
            };
          }
          async decodeOperation(e) {
            ...
            if (e.call_contract.contract_id !== (0, o.encodeBase58)(this.id))
              throw new Error(
                `Invalid contract id. Expected: ${(0, o.encodeBase58)(
                  this.id
                )}. Received: ${e.call_contract.contract_id}`
              );
      ...
      5635: (e, t, r) => {
        ...
        class s {
            ...
            for (;;)
              try {
                const r = {
                  ...
                  i = await o.json();
                if (void 0 !== i.result) return i.result;
                if (!i.error) throw new Error("undefined error");
                const { message: s, data: a } = i.error;
          ...
          async getNonce(e, t = !0) {
            const { nonce: r } = await this.call("chain.get_account_nonce", {
              account: e,
            });
            if (!t) return r;
            const i = (0, o.decodeBase64url)(r),
              s = n.koinos.chain.value_type.decode(i),
              a = n.koinos.chain.value_type.toObject(s, {
                longs: String,
                defaults: !0,
              });
            return Number(a.uint64_value);
          }
          ...
          async wait(e, t = "byBlock", r = 6e4) {
            ...
            if ("byTransactionId" === t) {
              ...
              throw new Error(`Transaction not mined after ${r} ms`);
            }
            const o = async (t, r, n) => {
              const o = await this.getBlocks(t, r, n);
              let i = 0;
              o.forEach((t) => {
                t &&
                  t.block &&
                  ...
                  (i = Number(t.block_height));
              });
              const s = o[o.length - 1].block_id;
              return [i, s];
            };
            let s = 0,
              a = 0,
            ...
            for (; Date.now() < n + r; ) {
              ...
              if (
                ...
                Number(e.height) === s - 1 && l && l !== e.id)
              ) {
                const [t, r] = await o(a, Number(e.height) - a + 1, e.id);
                if (t) return t;
                (l = r), (s = Number(e.height) + 1);
              }
              if (s > Number(e.height)) continue;
              const [t, r] = await o(s, 1, e.id);
              if (t) return t;
              l || (l = r), (s += 1);
            }
            throw new Error(
              `Transaction not mined after ${r} ms. Blocks checked from ${a} to ${s}`
            );
          }
      ...
      7187: (e, t, r) => {
        ...
        class a {
          ...
          btypeDecode(e, t) {
            const r = {};
            return (
              Object.keys(t.fields).forEach((n) => {
                const { options: a, name: l, type: c, rule: u } = t.fields[n];
                if (!e[l]) return;
                const d = { type: c };
                if (
                  (a &&
                  ...
                  if (s.includes(c)) r[l] = (0, o.btypeDecodeValue)(e[l], d);
                  else {
                    const t = this.root.lookupType(c);
                    r[l] = this.btypeDecode(e[l], t);
                  }
                else
                  r[l] = e[l].map((e) => {
                    if (!s.includes(c)) {
                      const t = this.root.lookupType(c);
                      return this.btypeDecode(e, t);
                    }
                    return (0, o.btypeDecodeValue)(e, d);
                  });
              }),
              r
            );
            ...
            return (
              Object.keys(t.fields).forEach((n) => {
                ...
                if (
                  ...
                  if (s.includes(c)) r[l] = (0, o.btypeEncodeValue)(e[l], d);
                  else {
                    const t = this.root.lookupType(c);
                    r[l] = this.btypeEncode(e[l], t);
                  }
                else
                  r[l] = e[l].map((e) => {
                    if (!s.includes(c)) {
                      const t = this.root.lookupType(c);
                      return this.btypeEncode(e, t);
                    }
                    return (0, o.btypeEncodeValue)(e, d);
                  });
              }),
              r
            );
          }
          async serialize(e, t, r) {
            const n = this.defaultType || this.root.lookupType(t);
            let o = {};
            o = (
              void 0 === (null == r ? void 0 : r.bytesConversion)
                ? this.bytesConversion
                : r.bytesConversion
            )
              ? this.btypeDecode(e, n)
              : e;
            const i = n.create(o);
            return n.encode(i).finish();
          }
          async deserialize(e, t, r) {
            const n = "string" == typeof e ? (0, o.decodeBase64url)(e) : e,
              i = this.defaultType || this.root.lookupType(t),
              s = i.decode(n),
              a = i.toObject(s, { longs: String, defaults: !0 });
            return (
              void 0 === (null == r ? void 0 : r.bytesConversion)
                ? this.bytesConversion
                : r.bytesConversion
            )
              ? this.btypeEncode(a, i)
              : a;
          }
        }
        (t.Serializer = a), (t.default = a);
      },
      6991: function (e, t, r) {
        "use strict";
        var n =
        ...
        class f {
          constructor(e) {
            (this.chainId = ""),
              ...
              e.privateKey,
              (this.publicKey = a.getPublicKey(e.privateKey, this.compressed)),
              (this.address = (0, l.bitcoinAddress)(this.publicKey)),
              e.chainId && (this.chainId = e.chainId);
          }
          static fromWif(e, t) {
            const r = void 0 === t ? "5" !== e[0] : t,
              n = (0, l.bitcoinDecode)(e);
            return new f({ privateKey: (0, l.toHexString)(n), compressed: r });
          }
          static fromSeed(e, t) {
            const r = (0, s.sha256)(e);
            return new f({ privateKey: r, compressed: t });
          }
          getAddress(e = !0) {
            if ("string" == typeof this.privateKey) {
              const t = a.getPublicKey(this.privateKey, e);
              return (0, l.bitcoinAddress)(t);
            }
            const t = a.getPublicKey(this.privateKey, e);
            return (0, l.bitcoinAddress)(t);
          }
          getPrivateKey(e = "hex", t) {
            ...
            r =
              this.privateKey instanceof Uint8Array
                ? (0, l.toHexString)(this.privateKey)
          ...
          async signHash(e) {
            const [t, r] = await a.sign(e, this.privateKey, {
                recovered: !0,
                canonical: !0,
                der: !1,
              }),
              n = new Uint8Array(65);
            return n.set([r + 31], 0), n.set(t, 1), n;
          }
          async signTransaction(e, t) {
            if (!e.id) throw new Error("Missing transaction id");
            const r = (0, l.toUint8Array)(e.id.slice(6)),
              n = await this.signHash(r);
            return (
              e.signatures || (e.signatures = []),
              e.signatures.push((0, l.encodeBase64url)(n)),
              e
            );
          }
          async signBlock(e) {
            if (!e.id) throw new Error("Missing block id");
            const t = (0, l.toUint8Array)(e.id.slice(6)),
              r = await this.signHash(t);
            return (e.signature = (0, l.encodeBase64url)(r)), e;
          }
          async sendTransaction(e, t) {
            ...
            const { receipt: n } = await this.provider.sendTransaction(e);
            return (
              (e.wait = async (t = "byBlock", r = 6e4) => {
                if (!this.provider) throw new Error("provider is undefined");
                return this.provider.wait(e.id, t, r);
              }),
              { receipt: n, transaction: e }
            );
          }
          static recoverPublicKey(e, t, r = !0) {
            const n = (0, l.toHexString)(t),
              o = Number(`0x${n.slice(0, 2)}`) - 31,
              i = n.slice(2, 66),
              s = n.slice(66),
              c = BigInt(`0x${i}`),
              u = BigInt(`0x${s}`),
              d = new a.Signature(c, u),
              p = a.recoverPublicKey((0, l.toHexString)(e), d.toHex(), o);
            if (!p) throw new Error("Public key cannot be recovered");
            return r ? a.Point.fromHex(p).toHex(!0) : (0, l.toHexString)(p);
          }
          async recoverPublicKeys(e, t) {
            let r = !0;
            t && void 0 !== t.compressed && (r = t.compressed);
            let n,
              o = [];
            const i = e;
            if (i.signature) {
              if (!i.header) throw new Error("Missing block header");
              if (!i.signature) throw new Error("Missing block signature");
              o = [i.signature];
              const e = (0, l.btypeDecode)(i.header, u),
                t = c.koinos.protocol.block_header.create(e);
              n = c.koinos.protocol.block_header.encode(t).finish();
            } else {
              const t = e;
              if (!t.header) throw new Error("Missing transaction header");
              if (!t.signatures)
                throw new Error("Missing transaction signatures");
              o = t.signatures;
              const r = (0, l.btypeDecode)(t.header, d),
                i = c.koinos.protocol.transaction_header.create(r);
              n = c.koinos.protocol.transaction_header.encode(i).finish();
            }
            const a = (0, s.sha256)(n);
            return Promise.all(
              o.map(
                async (e) => (
                  t &&
                    "function" == typeof t.transformSignature &&
                    (e = await t.transformSignature(e)),
                  f.recoverPublicKey(a, (0, l.decodeBase64url)(e), r)
                )
              )
            );
          }
          async recoverAddresses(e, t) {
            return (await this.recoverPublicKeys(e, t)).map((e) =>
              (0, l.bitcoinAddress)((0, l.toUint8Array)(e))
            );
          }
          async prepareTransaction(e) {
            ...
            e.header || (e.header = {});
            const n =
                null !== (t = e.header.payer) && void 0 !== t
                  ? t
                  : this.address,
              { payee: o } = e.header;
            let i, a;
            if (void 0 === e.header.nonce) {
              if (!this.provider)
                throw new Error(
                  "Cannot get the nonce because provider is undefined. To skip this call set a nonce in the transaction header"
                );
              const e = await this.provider.getNonce(o || n),
                t = c.koinos.chain.value_type.create({
                  uint64_value: String(e + 1),
                }),
                r = c.koinos.chain.value_type.encode(t).finish();
              i = (0, l.encodeBase64url)(r);
            } else i = e.header.nonce;
            if (void 0 === e.header.rc_limit) {
              if (!this.provider)
                throw new Error(
                  "Cannot get the rc_limit because provider is undefined. To skip this call set a rc_limit in the transaction header"
                );
              a = await this.provider.getAccountRc(n);
            } else a = e.header.rc_limit;
            let u = e.header.chain_id || this.chainId;
            if (!u) {
              if (!this.provider)
                throw new Error(
                  "Cannot get the chain_id because provider is undefined. To skip this call set a chain_id in the Signer"
                );
              (u = await this.provider.getChainId()), (this.chainId = u);
            }
            const f = [];
            if (e.operations)
              for (
                let t = 0;
                t <
                (null === (r = e.operations) || void 0 === r
                  ? void 0
                  : r.length);
                t += 1
              ) {
                const r = (0, l.btypeDecode)(e.operations[t], p),
                  n = c.koinos.protocol.operation.create(r),
                  o = c.koinos.protocol.operation.encode(n).finish();
                f.push((0, s.sha256)(o));
              }
            const h = (0, l.encodeBase64url)(
              new Uint8Array([18, 32, ...(0, l.calculateMerkleRoot)(f)])
            );
            e.header = {
              chain_id: u,
              rc_limit: a,
              nonce: i,
              operation_merkle_root: h,
              payer: n,
              ...(o && { payee: o }),
            };
            const y = (0, l.btypeDecode)(e.header, d),
              _ = c.koinos.protocol.transaction_header.create(y),
              g = c.koinos.protocol.transaction_header.encode(_).finish(),
              b = (0, s.sha256)(g);
            return (e.id = `0x1220${(0, l.toHexString)(b)}`), e;
          }
          async prepareBlock(e) {
            ...
            if (e.transactions)
              for (let n = 0; n < e.transactions.length; n++) {
                const o = e.transactions[n],
                  i = (0, l.btypeDecode)(o.header, d),
                  a = c.koinos.protocol.transaction_header.create(i),
                  u = c.koinos.protocol.transaction_header.encode(a).finish();
                r.push((0, s.sha256)(u));
                let p = new Uint8Array();
                null === (t = o.signatures) ||
                  void 0 === t ||
                  t.forEach((e) => {
                    p = new Uint8Array([...p, ...(0, l.decodeBase64url)(e)]);
                  }),
                  r.push((0, s.sha256)(p));
              }
            let {
            ...
            if (!n || !o || !i) {
              ...
              const e = await this.provider.getHeadInfo();
              (n = n || `${Number(e.head_topology.height) + 1}`),
                (o = o || e.head_topology.id),
                (i = i || e.head_state_merkle_root);
            }
            e.header = {
              height: n,
              previous: o,
              ...
              transaction_merkle_root: (0, l.encodeBase64url)(
                new Uint8Array([18, 32, ...(0, l.calculateMerkleRoot)(r)])
              ),
              signer: this.address,
            };
            const a = (0, l.btypeDecode)(e.header, u),
              p = c.koinos.protocol.block_header.create(a),
              f = c.koinos.protocol.block_header.encode(p).finish(),
              h = (0, s.sha256)(f);
            return (e.id = `0x1220${(0, l.toHexString)(h)}`), e;
          }
        }
        (t.Signer = f), (t.default = f);
      },
      5738: function (e, t, r) {
        "use strict";
        var n =
        ...
        (window.utils = s),
          ...
          (window.Signer = l.Signer),
          (window.Provider = c.Provider),
          (window.Serializer = u.Serializer);
      },
      8593: function (e, t, r) {
        "use strict";
        var n =
        ...
        function g(e, t, r = !1) {
          ...
          "public" === t
            ...
            : (r
              ...
              (o[0] = 128)),
            o.set(e, 1);
          const s = (0, l.sha256)(o),
            a = (0, l.sha256)(s),
            c = new Uint8Array(4);
          return c.set(a.slice(0, 4)), n.set(e, 1), n.set(c, i), f(n);
        }
        function b(e) {
        ...
        function m(e, t) {
          if ("bytes" !== t.type) return b(e);
          const r = e;
          if (!t.btype) return _(r);
          switch (t.btype) {
            case "BASE58":
            case "CONTRACT_ID":
            case "ADDRESS":
            ...
            case "TRANSACTION_ID":
              return d(r.slice(2));
            default:
              throw new Error(`unknown btype ${t.btype}`);
          }
        }
        function v(e, t) {
          if ("bytes" !== t.type) return b(e);
          const r = e;
          if (!t.btype) return y(r);
          switch (t.btype) {
            case "BASE58":
            case "CONTRACT_ID":
            case "ADDRESS":
        ...
        (t.toUint8Array = d),
          ...
          (t.encodeBase64 = function (e) {
            return new TextDecoder().decode(a.encode("M", e)).slice(1);
          }),
          (t.multihash = function (e, t = "sha2-256") {
            switch (t) {
              case "sha2-256":
                return new Uint8Array([18, e.length, ...e]);
              default:
                throw new Error(`multihash code ${t} not supported`);
            }
          }),
          (t.decodeBase64 = function (e) {
            return a.decode(`M${e}`);
          }),
          (t.calculateMerkleRoot = function (e) {
            if (!e.length) return (0, l.sha256)(new Uint8Array());
            for (; e.length > 1; ) {
              for (let t = 0; t < e.length; t += 2)
                if (t + 1 < e.length) {
                  const r = e[t],
                    n = e[t + 1],
                    o = (0, l.sha256)(new Uint8Array([...r, ...n]));
                  e[t / 2] = new Uint8Array(o);
                } else e[t / 2] = e[t];
              e = e.slice(0, Math.ceil(e.length / 2));
            }
            return e[0];
          }),
          (t.bitcoinEncode = g),
          ...
          (t.bitcoinAddress = function (e) {
            const t = (0, l.sha256)(e);
            return g((0, c.ripemd160)(t), "public");
          }),
          ...
          (t.parseUnits = function (e, t) {
            const r = "-" === e[0] ? "-" : "";
            let [n, o] = e.replace("-", "").replace(",", ".").split(".");
            return (
              o || (o = ""),
              (o = o.padEnd(t, "0")),
              `${r}${`${n}${o}`.replace(/^0+(?=\d)/, "")}`
          ...
          (t.btypeDecodeValue = m),
          (t.btypeEncodeValue = v),
          (t.btypeDecode = function e(t, r) {
            ...
            return (
              Object.keys(r).forEach((o) => {
                t[o] &&
                  ("repeated" === r[o].rule
                    ? (n[o] = t[o].map((t) =>
                        r[o].subtypes ? e(t, r[o].subtypes) : m(t, r[o])
                      ))
                    : r[o].subtypes
                    ? (n[o] = e(t[o], r[o].subtypes))
                    : (n[o] = m(t[o], r[o])));
              }),
              n
            );
          }),
          (t.btypeEncode = function e(t, r) {
            if ("object" != typeof t) return t;
            const n = {};
            return (
              Object.keys(r).forEach((o) => {
                t[o] &&
                  ("repeated" === r[o].rule
                    ? (n[o] = t[o].map((t) =>
                        r[o].subtypes ? e(t, r[o].subtypes) : v(t, r[o])
                      ))
                    : r[o].subtypes
                    ? (n[o] = e(t[o], r[o].subtypes))
                    : (n[o] = v(t[o], r[o])));
            ...
            (i =
              ...
              typeof (n = function (e) {
                ...
                var t,
                  ...
                  a = e.Writer,
                  l = e.util,
                  c = e.roots.default || (e.roots.default = {});
                return (
                  (c.koinos =
                    (((i = {}).protocol =
                      (((n = {}).event_data = (function () {
                        function t(e) {
                          if (((this.impacted = []), e))
                            for (
                        ...
                        return (
                          (t.prototype.sequence = 0),
                          (t.prototype.source = l.newBuffer([])),
                          (t.prototype.name = ""),
                          (t.prototype.data = l.newBuffer([])),
                          (t.prototype.impacted = l.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            if (
                              ...
                              null != e.sequence &&
                                ...
                                t.uint32(8).uint32(e.sequence),
                              null != e.source &&
                                Object.hasOwnProperty.call(e, "source") &&
                                t.uint32(18).bytes(e.source),
                              null != e.name &&
                                Object.hasOwnProperty.call(e, "name") &&
                                t.uint32(26).string(e.name),
                              null != e.data &&
                                Object.hasOwnProperty.call(e, "data") &&
                                t.uint32(34).bytes(e.data),
                              null != e.impacted && e.impacted.length)
                            )
                              for (var r = 0; r < e.impacted.length; ++r)
                                t.uint32(42).bytes(e.impacted[r]);
                            return t;
                          }),
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.event_data();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 4:
                                  ...
                                  break;
                                case 5:
                                  (n.impacted && n.impacted.length) ||
                                    (n.impacted = []),
                                    n.impacted.push(e.bytes());
                                  break;
                                default:
                                  e.skipType(7 & o);
                              }
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.impacted &&
                              e.hasOwnProperty("impacted")
                            ) {
                              if (!Array.isArray(e.impacted))
                                return "impacted: array expected";
                              for (var t = 0; t < e.impacted.length; ++t)
                                if (
                                  !(
                                    (e.impacted[t] &&
                                      "number" ==
                                        typeof e.impacted[t].length) ||
                                    l.isString(e.impacted[t])
                                  )
                                )
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.protocol.event_data)
                              return e;
                            var t = new c.koinos.protocol.event_data();
                            if (
                              (null != e.sequence &&
                                (t.sequence = e.sequence >>> 0),
                              null != e.source &&
                                ("string" == typeof e.source
                                  ? l.base64.decode(
                                      e.source,
                                      (t.source = l.newBuffer(
                                        l.base64.length(e.source)
                                      )),
                                      0
                                    )
                                  : e.source.length && (t.source = e.source)),
                              ...
                              t.impacted = [];
                              for (var r = 0; r < e.impacted.length; ++r)
                                "string" == typeof e.impacted[r]
                                  ? l.base64.decode(
                                      e.impacted[r],
                                      (t.impacted[r] = l.newBuffer(
                                        l.base64.length(e.impacted[r])
                                      )),
                                      0
                                    )
                                  : e.impacted[r].length &&
                                    (t.impacted[r] = e.impacted[r]);
                            }
                            return t;
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            var r = {};
                            if (
                              ((t.arrays || t.defaults) && (r.impacted = []),
                              t.defaults &&
                                ((r.sequence = 0),
                                t.bytes === String
                                  ? (r.source = "")
                                  : ((r.source = []),
                                    t.bytes !== Array &&
                                      (r.source = l.newBuffer(r.source))),
                                (r.name = ""),
                                t.bytes === String
                                  ? (r.data = "")
                                  : ((r.data = []),
                                    t.bytes !== Array &&
                                      (r.data = l.newBuffer(r.data)))),
                              null != e.sequence &&
                                e.hasOwnProperty("sequence") &&
                              ...
                              null != e.source &&
                                ...
                                (r.source =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.source)
                                    : e.source),
                              null != e.name &&
                                e.hasOwnProperty("name") &&
                                (r.name = e.name),
                              null != e.data &&
                                ...
                                (r.data =
                                  t.bytes === String
                                    ? l.base64.encode(e.data, 0, e.data.length)
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.data)
                                    : e.data),
                              e.impacted && e.impacted.length)
                            ) {
                              r.impacted = [];
                              for (var n = 0; n < e.impacted.length; ++n)
                                r.impacted[n] =
                                  t.bytes === String
                                    ? l.base64.encode(
                                        e.impacted[n],
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.impacted[n])
                                    : e.impacted[n];
                            }
                            return r;
                          }),
                      ...
                      (n.contract_call_bundle = (function () {
                        function t(e) {
                          if (e)
                            for (
                              var t = Object.keys(e), r = 0;
                        ...
                        return (
                          (t.prototype.contract_id = l.newBuffer([])),
                          (t.prototype.entry_point = 0),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            return (
                              t || (t = a.create()),
                              null != e.contract_id &&
                                Object.hasOwnProperty.call(e, "contract_id") &&
                                t.uint32(10).bytes(e.contract_id),
                              null != e.entry_point &&
                                Object.hasOwnProperty.call(e, "entry_point") &&
                                t.uint32(16).uint32(e.entry_point),
                              t
                            );
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new c.koinos.protocol.contract_call_bundle();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  n.contract_id = e.bytes();
                                  break;
                                case 2:
                                  n.entry_point = e.uint32();
                                  break;
                                default:
                                  e.skipType(7 & o);
                              }
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ? "object expected"
                              : null != e.contract_id &&
                                e.hasOwnProperty("contract_id") &&
                                !(
                                  (e.contract_id &&
                                    "number" == typeof e.contract_id.length) ||
                                  l.isString(e.contract_id)
                                )
                              ? "contract_id: buffer expected"
                              : null != e.entry_point &&
                                e.hasOwnProperty("entry_point") &&
                                !l.isInteger(e.entry_point)
                              ? "entry_point: integer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              c.koinos.protocol.contract_call_bundle
                            )
                              return e;
                            var t =
                              new c.koinos.protocol.contract_call_bundle();
                            return (
                              null != e.contract_id &&
                                ("string" == typeof e.contract_id
                                  ? l.base64.decode(
                                      e.contract_id,
                                      (t.contract_id = l.newBuffer(
                                        l.base64.length(e.contract_id)
                                      )),
                                      0
                                    )
                                  : e.contract_id.length &&
                                    (t.contract_id = e.contract_id)),
                              null != e.entry_point &&
                                (t.entry_point = e.entry_point >>> 0),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                              ...
                              null != e.contract_id &&
                                ...
                                (r.contract_id =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.contract_id)
                                    : e.contract_id),
                              null != e.entry_point &&
                                e.hasOwnProperty("entry_point") &&
                                (r.entry_point = e.entry_point),
                              r
                            );
                          }),
                          (t.prototype.toJSON = function () {
                      ...
                      (n.system_call_target = (function () {
                        ...
                        var r;
                        return (
                          (t.prototype.thunk_id = null),
                          (t.prototype.system_call_bundle = null),
                          Object.defineProperty(t.prototype, "target", {
                            get: l.oneOfGetter(
                              (r = ["thunk_id", "system_call_bundle"])
                            ),
                            set: l.oneOfSetter(r),
                          }),
                          (t.create = function (e) {
                          ...
                          (t.encode = function (e, t) {
                            return (
                              t || (t = a.create()),
                              null != e.thunk_id &&
                                Object.hasOwnProperty.call(e, "thunk_id") &&
                                t.uint32(8).uint32(e.thunk_id),
                              null != e.system_call_bundle &&
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.system_call_target();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  ...
                                  break;
                                case 2:
                                  n.system_call_bundle =
                                    c.koinos.protocol.contract_call_bundle.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.thunk_id &&
                              e.hasOwnProperty("thunk_id") &&
                              ((t.target = 1), !l.isInteger(e.thunk_id))
                            )
                              return "thunk_id: integer expected";
                            if (
                              null != e.system_call_bundle &&
                              e.hasOwnProperty("system_call_bundle")
                            ) {
                              if (1 === t.target)
                                return "target: multiple values";
                              t.target = 1;
                              var r =
                                c.koinos.protocol.contract_call_bundle.verify(
                                  e.system_call_bundle
                                );
                              if (r) return "system_call_bundle." + r;
                            }
                            return null;
                          }),
                          (t.fromObject = function (e) {
                            if (
                              e instanceof c.koinos.protocol.system_call_target
                            )
                              return e;
                            var t = new c.koinos.protocol.system_call_target();
                            if (
                              (null != e.thunk_id &&
                                (t.thunk_id = e.thunk_id >>> 0),
                              null != e.system_call_bundle)
                            ) {
                              ...
                              t.system_call_bundle =
                                c.koinos.protocol.contract_call_bundle.fromObject(
                                  e.system_call_bundle
                                );
                            }
                            return t;
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              null != e.thunk_id &&
                                e.hasOwnProperty("thunk_id") &&
                                ((r.thunk_id = e.thunk_id),
                                t.oneofs && (r.target = "thunk_id")),
                              null != e.system_call_bundle &&
                                e.hasOwnProperty("system_call_bundle") &&
                                ((r.system_call_bundle =
                                  c.koinos.protocol.contract_call_bundle.toObject(
                                    e.system_call_bundle,
                                    t
                                  )),
                                t.oneofs && (r.target = "system_call_bundle")),
                              r
                            );
                          }),
                          (t.prototype.toJSON = function () {
                      ...
                      (n.upload_contract_operation = (function () {
                        function t(e) {
                          if (e)
                            for (
                              var t = Object.keys(e), r = 0;
                        ...
                        return (
                          (t.prototype.contract_id = l.newBuffer([])),
                          (t.prototype.bytecode = l.newBuffer([])),
                          (t.prototype.abi = ""),
                          (t.prototype.authorizes_call_contract = !1),
                          (t.prototype.authorizes_transaction_application = !1),
                          (t.prototype.authorizes_upload_contract = !1),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            return (
                              ...
                              null != e.contract_id &&
                                ...
                                t.uint32(10).bytes(e.contract_id),
                              null != e.bytecode &&
                                Object.hasOwnProperty.call(e, "bytecode") &&
                                t.uint32(18).bytes(e.bytecode),
                              null != e.abi &&
                                Object.hasOwnProperty.call(e, "abi") &&
                                t.uint32(26).string(e.abi),
                              null != e.authorizes_call_contract &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "authorizes_call_contract"
                                ) &&
                                t.uint32(32).bool(e.authorizes_call_contract),
                              null != e.authorizes_transaction_application &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "authorizes_transaction_application"
                                ) &&
                                t
                                  .uint32(40)
                                  .bool(e.authorizes_transaction_application),
                              null != e.authorizes_upload_contract &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "authorizes_upload_contract"
                                ) &&
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new c.koinos.protocol.upload_contract_operation();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 3:
                                  ...
                                  break;
                                case 4:
                                  n.authorizes_call_contract = e.bool();
                                  break;
                                case 5:
                                  n.authorizes_transaction_application =
                                    e.bool();
                                  break;
                                case 6:
                                  n.authorizes_upload_contract = e.bool();
                                  break;
                                default:
                                  e.skipType(7 & o);
                              }
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ...
                              ? "contract_id: buffer expected"
                              : null != e.bytecode &&
                                e.hasOwnProperty("bytecode") &&
                                !(
                                  (e.bytecode &&
                                    "number" == typeof e.bytecode.length) ||
                                  l.isString(e.bytecode)
                                )
                              ? "bytecode: buffer expected"
                              : null != e.abi &&
                                e.hasOwnProperty("abi") &&
                                !l.isString(e.abi)
                              ? "abi: string expected"
                              : null != e.authorizes_call_contract &&
                                e.hasOwnProperty("authorizes_call_contract") &&
                                "boolean" != typeof e.authorizes_call_contract
                              ? "authorizes_call_contract: boolean expected"
                              : null != e.authorizes_transaction_application &&
                                e.hasOwnProperty(
                                  "authorizes_transaction_application"
                                ) &&
                                "boolean" !=
                                  typeof e.authorizes_transaction_application
                              ? "authorizes_transaction_application: boolean expected"
                              : null != e.authorizes_upload_contract &&
                                e.hasOwnProperty(
                                  "authorizes_upload_contract"
                                ) &&
                                "boolean" != typeof e.authorizes_upload_contract
                              ? "authorizes_upload_contract: boolean expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              c.koinos.protocol.upload_contract_operation
                            )
                              return e;
                            var t =
                              new c.koinos.protocol.upload_contract_operation();
                              ...
                              null != e.contract_id &&
                                ("string" == typeof e.contract_id
                                  ...
                                  : e.contract_id.length &&
                                    (t.contract_id = e.contract_id)),
                              null != e.bytecode &&
                                ("string" == typeof e.bytecode
                                  ? l.base64.decode(
                                      e.bytecode,
                                      (t.bytecode = l.newBuffer(
                                        l.base64.length(e.bytecode)
                                      )),
                                      0
                                    )
                                  : e.bytecode.length &&
                                    (t.bytecode = e.bytecode)),
                              null != e.abi && (t.abi = String(e.abi)),
                              null != e.authorizes_call_contract &&
                                (t.authorizes_call_contract = Boolean(
                                  e.authorizes_call_contract
                                )),
                              null != e.authorizes_transaction_application &&
                                (t.authorizes_transaction_application = Boolean(
                                  e.authorizes_transaction_application
                                )),
                              null != e.authorizes_upload_contract &&
                                (t.authorizes_upload_contract = Boolean(
                            ...
                            return (
                              t.defaults &&
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.bytecode = []),
                                    t.bytes !== Array &&
                                      (r.bytecode = l.newBuffer(r.bytecode))),
                                (r.abi = ""),
                                (r.authorizes_call_contract = !1),
                                (r.authorizes_transaction_application = !1),
                                (r.authorizes_upload_contract = !1)),
                              null != e.contract_id &&
                                e.hasOwnProperty("contract_id") &&
                                (r.contract_id =
                                  t.bytes === String
                              ...
                              null != e.bytecode &&
                                ...
                                (r.bytecode =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.bytecode)
                                    : e.bytecode),
                              null != e.abi &&
                                e.hasOwnProperty("abi") &&
                                (r.abi = e.abi),
                              null != e.authorizes_call_contract &&
                                e.hasOwnProperty("authorizes_call_contract") &&
                                (r.authorizes_call_contract =
                                  e.authorizes_call_contract),
                              null != e.authorizes_transaction_application &&
                                e.hasOwnProperty(
                                  "authorizes_transaction_application"
                                ) &&
                                (r.authorizes_transaction_application =
                                  e.authorizes_transaction_application),
                              null != e.authorizes_upload_contract &&
                                e.hasOwnProperty(
                                  "authorizes_upload_contract"
                      ...
                      (n.call_contract_operation = (function () {
                        function t(e) {
                          if (e)
                            for (
                              var t = Object.keys(e), r = 0;
                        ...
                        return (
                          ...
                          (t.encode = function (e, t) {
                            return (
                              ...
                              null != e.entry_point &&
                                ...
                                t.uint32(16).uint32(e.entry_point),
                              null != e.args &&
                                Object.hasOwnProperty.call(e, "args") &&
                                t.uint32(26).bytes(e.args),
                              t
                            );
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new c.koinos.protocol.call_contract_operation();
                              e.pos < r;
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ...
                              : null != e.args &&
                                ...
                                !(
                                  (e.args &&
                                    "number" == typeof e.args.length) ||
                                  l.isString(e.args)
                                )
                              ? "args: buffer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              c.koinos.protocol.call_contract_operation
                            )
                              return e;
                            var t =
                              new c.koinos.protocol.call_contract_operation();
                            return (
                              ...
                              null != e.entry_point &&
                                (t.entry_point = e.entry_point >>> 0),
                              null != e.args &&
                                ("string" == typeof e.args
                                  ? l.base64.decode(
                                      e.args,
                                      (t.args = l.newBuffer(
                                        l.base64.length(e.args)
                                      )),
                                      0
                                    )
                                  : e.args.length && (t.args = e.args)),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              ...
                              null != e.args &&
                                ...
                                (r.args =
                                  t.bytes === String
                                    ? l.base64.encode(e.args, 0, e.args.length)
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.args)
                                    : e.args),
                              r
                            );
                          }),
                      ...
                      (n.set_system_call_operation = (function () {
                        function t(e) {
                          if (e)
                            for (
                              var t = Object.keys(e), r = 0;
                        ...
                        return (
                          ...
                          (t.encode = function (e, t) {
                            return (
                              t || (t = a.create()),
                              null != e.call_id &&
                                Object.hasOwnProperty.call(e, "call_id") &&
                                t.uint32(8).uint32(e.call_id),
                              null != e.target &&
                                Object.hasOwnProperty.call(e, "target") &&
                                c.koinos.protocol.system_call_target
                                  .encode(e.target, t.uint32(18).fork())
                                  .ldelim(),
                              t
                            );
                          }),
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new c.koinos.protocol.set_system_call_operation();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 2:
                                  n.target =
                                    c.koinos.protocol.system_call_target.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.call_id &&
                              e.hasOwnProperty("call_id") &&
                              !l.isInteger(e.call_id)
                            )
                            ...
                            if (
                              ...
                              var t =
                                c.koinos.protocol.system_call_target.verify(
                                  e.target
                                );
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              c.koinos.protocol.set_system_call_operation
                            )
                              return e;
                            var t =
                              new c.koinos.protocol.set_system_call_operation();
                            if (
                              ...
                              t.target =
                                c.koinos.protocol.system_call_target.fromObject(
                                  e.target
                                );
                            }
                            return t;
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              ...
                              null != e.target &&
                                e.hasOwnProperty("target") &&
                                (r.target =
                                  c.koinos.protocol.system_call_target.toObject(
                                    e.target,
                                    t
                                  )),
                              r
                      ...
                      (n.set_system_contract_operation = (function () {
                        function t(e) {
                          if (e)
                            for (
                              var t = Object.keys(e), r = 0;
                        ...
                        return (
                          ...
                          (t.encode = function (e, t) {
                            return (
                              ...
                              null != e.contract_id &&
                                Object.hasOwnProperty.call(e, "contract_id") &&
                                t.uint32(10).bytes(e.contract_id),
                              null != e.system_contract &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "system_contract"
                                ) &&
                                t.uint32(16).bool(e.system_contract),
                              t
                            );
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n =
                                  new c.koinos.protocol.set_system_contract_operation();
                              e.pos < r;
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ...
                              ? "contract_id: buffer expected"
                              : null != e.system_contract &&
                                e.hasOwnProperty("system_contract") &&
                                "boolean" != typeof e.system_contract
                              ? "system_contract: boolean expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (
                              e instanceof
                              c.koinos.protocol.set_system_contract_operation
                            )
                              return e;
                            var t =
                              new c.koinos.protocol.set_system_contract_operation();
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              ...
                              null != e.system_contract &&
                                e.hasOwnProperty("system_contract") &&
                                (r.system_contract = e.system_contract),
                              r
                            );
                          }),
                          (t.prototype.toJSON = function () {
                      ...
                      (n.operation = (function () {
                        ...
                        var r;
                        return (
                          (t.prototype.upload_contract = null),
                          (t.prototype.call_contract = null),
                          (t.prototype.set_system_call = null),
                          (t.prototype.set_system_contract = null),
                            ...
                            return (
                              ...
                              null != e.upload_contract &&
                                ...
                                c.koinos.protocol.upload_contract_operation
                                  ...
                                  .ldelim(),
                              null != e.call_contract &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "call_contract"
                                ) &&
                                c.koinos.protocol.call_contract_operation
                                  .encode(e.call_contract, t.uint32(18).fork())
                                  .ldelim(),
                              null != e.set_system_call &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "set_system_call"
                                ) &&
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.operation();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  n.upload_contract =
                                    c.koinos.protocol.upload_contract_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 2:
                                  n.call_contract =
                                    c.koinos.protocol.call_contract_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 3:
                                  n.set_system_call =
                                    c.koinos.protocol.set_system_call_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 4:
                                  n.set_system_contract =
                                    c.koinos.protocol.set_system_contract_operation.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.upload_contract &&
                              e.hasOwnProperty("upload_contract") &&
                              ((t.op = 1),
                              (r =
                                c.koinos.protocol.upload_contract_operation.verify(
                                  e.upload_contract
                                )))
                            )
                              return "upload_contract." + r;
                            if (
                              null != e.call_contract &&
                              e.hasOwnProperty("call_contract")
                            ) {
                              if (1 === t.op) return "op: multiple values";
                              if (
                                ((t.op = 1),
                                (r =
                                  c.koinos.protocol.call_contract_operation.verify(
                                    e.call_contract
                                  )))
                              )
                                return "call_contract." + r;
                            }
                            if (
                              null != e.set_system_call &&
                              e.hasOwnProperty("set_system_call")
                            ) {
                              if (1 === t.op) return "op: multiple values";
                              if (
                                ((t.op = 1),
                                (r =
                                  c.koinos.protocol.set_system_call_operation.verify(
                                    e.set_system_call
                                  )))
                              )
                                return "set_system_call." + r;
                            }
                            if (
                              null != e.set_system_contract &&
                              e.hasOwnProperty("set_system_contract")
                            ) {
                              if (1 === t.op) return "op: multiple values";
                              var r;
                              if (
                                ((t.op = 1),
                                (r =
                                  c.koinos.protocol.set_system_contract_operation.verify(
                                    e.set_system_contract
                                  )))
                              )
                                return "set_system_contract." + r;
                            }
                            return null;
                          }),
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.protocol.operation)
                              return e;
                            var t = new c.koinos.protocol.operation();
                            if (null != e.upload_contract) {
                              if ("object" != typeof e.upload_contract)
                                throw TypeError(
                                  ".koinos.protocol.operation.upload_contract: object expected"
                                );
                              t.upload_contract =
                                c.koinos.protocol.upload_contract_operation.fromObject(
                                  e.upload_contract
                                );
                            }
                            if (null != e.call_contract) {
                              if ("object" != typeof e.call_contract)
                                throw TypeError(
                                  ".koinos.protocol.operation.call_contract: object expected"
                                );
                              t.call_contract =
                                c.koinos.protocol.call_contract_operation.fromObject(
                                  e.call_contract
                                );
                            }
                            if (null != e.set_system_call) {
                              if ("object" != typeof e.set_system_call)
                                throw TypeError(
                                  ".koinos.protocol.operation.set_system_call: object expected"
                                );
                              t.set_system_call =
                                c.koinos.protocol.set_system_call_operation.fromObject(
                                  e.set_system_call
                                );
                            }
                            if (null != e.set_system_contract) {
                              if ("object" != typeof e.set_system_contract)
                                throw TypeError(
                                  ".koinos.protocol.operation.set_system_contract: object expected"
                                );
                              t.set_system_contract =
                                c.koinos.protocol.set_system_contract_operation.fromObject(
                                  e.set_system_contract
                                );
                            }
                            return t;
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              null != e.upload_contract &&
                                e.hasOwnProperty("upload_contract") &&
                                ((r.upload_contract =
                                  c.koinos.protocol.upload_contract_operation.toObject(
                                    e.upload_contract,
                                    t
                                  )),
                                t.oneofs && (r.op = "upload_contract")),
                              null != e.call_contract &&
                                e.hasOwnProperty("call_contract") &&
                                ((r.call_contract =
                                  c.koinos.protocol.call_contract_operation.toObject(
                                    e.call_contract,
                                    t
                                  )),
                                t.oneofs && (r.op = "call_contract")),
                              null != e.set_system_call &&
                                e.hasOwnProperty("set_system_call") &&
                                ((r.set_system_call =
                                  c.koinos.protocol.set_system_call_operation.toObject(
                                    e.set_system_call,
                                    t
                                  )),
                                t.oneofs && (r.op = "set_system_call")),
                              null != e.set_system_contract &&
                                e.hasOwnProperty("set_system_contract") &&
                                ((r.set_system_contract =
                                  c.koinos.protocol.set_system_contract_operation.toObject(
                                    e.set_system_contract,
                                    t
                                  )),
                                t.oneofs && (r.op = "set_system_contract")),
                              r
                            );
                          }),
                          (t.prototype.toJSON = function () {
                      ...
                      (n.transaction_header = (function () {
                        ...
                        return (
                          (t.prototype.chain_id = l.newBuffer([])),
                          (t.prototype.rc_limit = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.nonce = l.newBuffer([])),
                          (t.prototype.operation_merkle_root = l.newBuffer([])),
                          (t.prototype.payer = l.newBuffer([])),
                          (t.prototype.payee = l.newBuffer([])),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            return (
                              t || (t = a.create()),
                              null != e.chain_id &&
                                Object.hasOwnProperty.call(e, "chain_id") &&
                                t.uint32(10).bytes(e.chain_id),
                              null != e.rc_limit &&
                                Object.hasOwnProperty.call(e, "rc_limit") &&
                                t.uint32(16).uint64(e.rc_limit),
                              null != e.nonce &&
                                Object.hasOwnProperty.call(e, "nonce") &&
                                t.uint32(26).bytes(e.nonce),
                              null != e.operation_merkle_root &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "operation_merkle_root"
                                ) &&
                                t.uint32(34).bytes(e.operation_merkle_root),
                              null != e.payer &&
                                Object.hasOwnProperty.call(e, "payer") &&
                                t.uint32(42).bytes(e.payer),
                              null != e.payee &&
                                Object.hasOwnProperty.call(e, "payee") &&
                                t.uint32(50).bytes(e.payee),
                              t
                            );
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.transaction_header();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 3:
                                  ...
                                  break;
                                case 4:
                                  n.operation_merkle_root = e.bytes();
                                  break;
                                case 5:
                                  n.payer = e.bytes();
                                  break;
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ? "object expected"
                              : null != e.chain_id &&
                                e.hasOwnProperty("chain_id") &&
                                !(
                                  (e.chain_id &&
                                    "number" == typeof e.chain_id.length) ||
                                  l.isString(e.chain_id)
                                )
                              ? "chain_id: buffer expected"
                              : null != e.rc_limit &&
                                e.hasOwnProperty("rc_limit") &&
                                !(
                                  l.isInteger(e.rc_limit) ||
                                  (e.rc_limit &&
                                    l.isInteger(e.rc_limit.low) &&
                                    l.isInteger(e.rc_limit.high))
                                )
                              ? "rc_limit: integer|Long expected"
                              : null != e.nonce &&
                                e.hasOwnProperty("nonce") &&
                                !(
                                  (e.nonce &&
                                    "number" == typeof e.nonce.length) ||
                                  l.isString(e.nonce)
                                )
                              ? "nonce: buffer expected"
                              : null != e.operation_merkle_root &&
                                e.hasOwnProperty("operation_merkle_root") &&
                                !(
                                  (e.operation_merkle_root &&
                                    "number" ==
                                      typeof e.operation_merkle_root.length) ||
                                  l.isString(e.operation_merkle_root)
                                )
                              ? "operation_merkle_root: buffer expected"
                              : null != e.payer &&
                                e.hasOwnProperty("payer") &&
                                !(
                                  (e.payer &&
                                    "number" == typeof e.payer.length) ||
                                  l.isString(e.payer)
                                )
                              ? "payer: buffer expected"
                              : null != e.payee &&
                                e.hasOwnProperty("payee") &&
                                !(
                                  (e.payee &&
                                    "number" == typeof e.payee.length) ||
                                  l.isString(e.payee)
                                )
                              ? "payee: buffer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (
                              e instanceof c.koinos.protocol.transaction_header
                            )
                              return e;
                            var t = new c.koinos.protocol.transaction_header();
                            return (
                              null != e.chain_id &&
                                ("string" == typeof e.chain_id
                                  ? l.base64.decode(
                                      e.chain_id,
                                      (t.chain_id = l.newBuffer(
                                        l.base64.length(e.chain_id)
                                      )),
                                      0
                                    )
                                  : e.chain_id.length &&
                                    (t.chain_id = e.chain_id)),
                              null != e.rc_limit &&
                                (l.Long
                                  ? ((t.rc_limit = l.Long.fromValue(
                                      e.rc_limit
                                    )).unsigned = !0)
                                  : "string" == typeof e.rc_limit
                                  ? (t.rc_limit = parseInt(e.rc_limit, 10))
                                  : "number" == typeof e.rc_limit
                                  ? (t.rc_limit = e.rc_limit)
                                  : "object" == typeof e.rc_limit &&
                                    (t.rc_limit = new l.LongBits(
                                      e.rc_limit.low >>> 0,
                                      e.rc_limit.high >>> 0
                                    ).toNumber(!0))),
                              null != e.nonce &&
                                ("string" == typeof e.nonce
                                  ? l.base64.decode(
                                      e.nonce,
                                      (t.nonce = l.newBuffer(
                                        l.base64.length(e.nonce)
                                      )),
                                      0
                                    )
                                  : e.nonce.length && (t.nonce = e.nonce)),
                              null != e.operation_merkle_root &&
                                ("string" == typeof e.operation_merkle_root
                                  ? l.base64.decode(
                                      e.operation_merkle_root,
                                      (t.operation_merkle_root = l.newBuffer(
                                        l.base64.length(e.operation_merkle_root)
                                      )),
                                      0
                                    )
                                  : e.operation_merkle_root.length &&
                                    (t.operation_merkle_root =
                                      e.operation_merkle_root)),
                              null != e.payer &&
                                ("string" == typeof e.payer
                                  ? l.base64.decode(
                                      e.payer,
                                      (t.payer = l.newBuffer(
                                        l.base64.length(e.payer)
                                      )),
                                      0
                                    )
                                  : e.payer.length && (t.payer = e.payer)),
                              null != e.payee &&
                                ("string" == typeof e.payee
                                  ? l.base64.decode(
                                      e.payee,
                                      (t.payee = l.newBuffer(
                                        l.base64.length(e.payee)
                                      )),
                                      0
                                    )
                                  : e.payee.length && (t.payee = e.payee)),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            if (t.defaults) {
                              if (
                                (t.bytes === String
                                  ...
                                  : ((r.chain_id = []),
                                    t.bytes !== Array &&
                                      (r.chain_id = l.newBuffer(r.chain_id))),
                                l.Long)
                              ) {
                                var n = new l.Long(0, 0, !0);
                                r.rc_limit =
                                  t.longs === String
                                    ? n.toString()
                                    : t.longs === Number
                                    ? n.toNumber()
                                    : n;
                              } else r.rc_limit = t.longs === String ? "0" : 0;
                              t.bytes === String
                                ? (r.nonce = "")
                                : ((r.nonce = []),
                                  t.bytes !== Array &&
                                    (r.nonce = l.newBuffer(r.nonce))),
                                t.bytes === String
                                  ? (r.operation_merkle_root = "")
                                  : ((r.operation_merkle_root = []),
                                    t.bytes !== Array &&
                                      (r.operation_merkle_root = l.newBuffer(
                                        r.operation_merkle_root
                                      ))),
                                t.bytes === String
                                  ? (r.payer = "")
                                  : ((r.payer = []),
                                    t.bytes !== Array &&
                                      (r.payer = l.newBuffer(r.payer))),
                                t.bytes === String
                                  ? (r.payee = "")
                                  : ((r.payee = []),
                                    t.bytes !== Array &&
                                      (r.payee = l.newBuffer(r.payee)));
                            }
                            return (
                              null != e.chain_id &&
                                e.hasOwnProperty("chain_id") &&
                                (r.chain_id =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.chain_id)
                                    : e.chain_id),
                              null != e.rc_limit &&
                                e.hasOwnProperty("rc_limit") &&
                                ("number" == typeof e.rc_limit
                                  ...
                                  : (r.rc_limit =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                                            e.rc_limit
                                          )
                                        : t.longs === Number
                                        ? new l.LongBits(
                              ...
                              null != e.nonce &&
                                ...
                                (r.nonce =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.nonce)
                                    : e.nonce),
                              null != e.operation_merkle_root &&
                                e.hasOwnProperty("operation_merkle_root") &&
                                (r.operation_merkle_root =
                              ...
                              null != e.payer &&
                                ...
                                (r.payer =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.payer)
                                    : e.payer),
                              null != e.payee &&
                                e.hasOwnProperty("payee") &&
                                (r.payee =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.payee)
                                    : e.payee),
                              r
                            );
                          }),
                      ...
                      (n.transaction = (function () {
                        function t(e) {
                          if (
                            ((this.operations = []), (this.signatures = []), e)
                          )
                            for (
                              var t = Object.keys(e), r = 0;
                              r < t.length;
                        ...
                        return (
                          (t.prototype.id = l.newBuffer([])),
                          (t.prototype.header = null),
                          (t.prototype.operations = l.emptyArray),
                          (t.prototype.signatures = l.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            if (
                              ...
                              null != e.id &&
                                ...
                                t.uint32(10).bytes(e.id),
                              null != e.header &&
                                Object.hasOwnProperty.call(e, "header") &&
                                c.koinos.protocol.transaction_header
                                  .encode(e.header, t.uint32(18).fork())
                                  .ldelim(),
                              null != e.operations && e.operations.length)
                            )
                              for (var r = 0; r < e.operations.length; ++r)
                                c.koinos.protocol.operation
                                  .encode(e.operations[r], t.uint32(26).fork())
                                  .ldelim();
                            if (null != e.signatures && e.signatures.length)
                              for (r = 0; r < e.signatures.length; ++r)
                                t.uint32(34).bytes(e.signatures[r]);
                            return t;
                          }),
                          (t.encodeDelimited = function (e, t) {
                            return this.encode(e, t).ldelim();
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.transaction();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 2:
                                  n.header =
                                    c.koinos.protocol.transaction_header.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 3:
                                  (n.operations && n.operations.length) ||
                                    (n.operations = []),
                                    n.operations.push(
                                      c.koinos.protocol.operation.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                                  break;
                                case 4:
                                  (n.signatures && n.signatures.length) ||
                                    (n.signatures = []),
                                    n.signatures.push(e.bytes());
                                  break;
                                default:
                                  e.skipType(7 & o);
                              }
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              e.hasOwnProperty("id") &&
                              !(
                                (e.id && "number" == typeof e.id.length) ||
                                l.isString(e.id)
                              )
                            )
                            ...
                            if (
                              ...
                              (r = c.koinos.protocol.transaction_header.verify(
                                e.header
                              ))
                            )
                              return "header." + r;
                            if (
                              ...
                              for (var t = 0; t < e.operations.length; ++t) {
                                var r;
                                if (
                                  (r = c.koinos.protocol.operation.verify(
                                    e.operations[t]
                                  ))
                                )
                                  return "operations." + r;
                            ...
                            if (
                              null != e.signatures &&
                              e.hasOwnProperty("signatures")
                            ) {
                              if (!Array.isArray(e.signatures))
                                return "signatures: array expected";
                              for (t = 0; t < e.signatures.length; ++t)
                                if (
                                  !(
                                    (e.signatures[t] &&
                                      "number" ==
                                        typeof e.signatures[t].length) ||
                                    l.isString(e.signatures[t])
                                  )
                                )
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.protocol.transaction)
                              return e;
                            var t = new c.koinos.protocol.transaction();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? l.base64.decode(
                                      e.id,
                                      (t.id = l.newBuffer(
                                        l.base64.length(e.id)
                                      )),
                                      0
                                    )
                                  : e.id.length && (t.id = e.id)),
                              null != e.header)
                            ) {
                              ...
                              t.header =
                                c.koinos.protocol.transaction_header.fromObject(
                                  e.header
                                );
                            }
                            if (e.operations) {
                              ...
                              t.operations = [];
                              for (var r = 0; r < e.operations.length; ++r) {
                                if ("object" != typeof e.operations[r])
                                  throw TypeError(
                                    ".koinos.protocol.transaction.operations: object expected"
                                  );
                                t.operations[r] =
                                  c.koinos.protocol.operation.fromObject(
                                    e.operations[r]
                                  );
                              }
                            }
                            if (e.signatures) {
                              ...
                              for (
                                t.signatures = [], r = 0;
                                r < e.signatures.length;
                                ++r
                              )
                                "string" == typeof e.signatures[r]
                                  ? l.base64.decode(
                                      e.signatures[r],
                                      (t.signatures[r] = l.newBuffer(
                                        l.base64.length(e.signatures[r])
                                      )),
                                      0
                                    )
                                  : e.signatures[r].length &&
                                    (t.signatures[r] = e.signatures[r]);
                            }
                            return t;
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ((t.arrays || t.defaults) &&
                                ((r.operations = []), (r.signatures = [])),
                              t.defaults &&
                                (t.bytes === String
                                  ? (r.id = "")
                                  : ((r.id = []),
                                    t.bytes !== Array &&
                                      (r.id = l.newBuffer(r.id))),
                                (r.header = null)),
                              null != e.id &&
                                e.hasOwnProperty("id") &&
                                (r.id =
                                  t.bytes === String
                                    ? l.base64.encode(e.id, 0, e.id.length)
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.id)
                                    : e.id),
                              null != e.header &&
                                e.hasOwnProperty("header") &&
                                (r.header =
                                  c.koinos.protocol.transaction_header.toObject(
                                    e.header,
                                    t
                                  )),
                              e.operations && e.operations.length)
                            ) {
                              r.operations = [];
                              for (var n = 0; n < e.operations.length; ++n)
                                r.operations[n] =
                                  c.koinos.protocol.operation.toObject(
                                    e.operations[n],
                                    t
                                  );
                            }
                      ...
                      (n.transaction_receipt = (function () {
                        function t(e) {
                          if (((this.events = []), (this.logs = []), e))
                            for (
                              var t = Object.keys(e), r = 0;
                              r < t.length;
                              ++r
                        ...
                        return (
                          (t.prototype.id = l.newBuffer([])),
                          (t.prototype.payer = l.newBuffer([])),
                          (t.prototype.max_payer_rc = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.rc_limit = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.rc_used = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.disk_storage_used = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.network_bandwidth_used = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.compute_bandwidth_used = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.reverted = !1),
                          (t.prototype.events = l.emptyArray),
                          (t.prototype.logs = l.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            if (
                              ...
                              null != e.payer &&
                                Object.hasOwnProperty.call(e, "payer") &&
                                t.uint32(18).bytes(e.payer),
                              null != e.max_payer_rc &&
                                Object.hasOwnProperty.call(e, "max_payer_rc") &&
                                t.uint32(24).uint64(e.max_payer_rc),
                              null != e.rc_limit &&
                                Object.hasOwnProperty.call(e, "rc_limit") &&
                                t.uint32(32).uint64(e.rc_limit),
                              null != e.rc_used &&
                                Object.hasOwnProperty.call(e, "rc_used") &&
                                t.uint32(40).uint64(e.rc_used),
                              null != e.disk_storage_used &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "disk_storage_used"
                                ) &&
                                t.uint32(48).uint64(e.disk_storage_used),
                              null != e.network_bandwidth_used &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "network_bandwidth_used"
                                ) &&
                                t.uint32(56).uint64(e.network_bandwidth_used),
                              null != e.compute_bandwidth_used &&
                                Object.hasOwnProperty.call(
                                  e,
                              ...
                              null != e.reverted &&
                                Object.hasOwnProperty.call(e, "reverted") &&
                                t.uint32(72).bool(e.reverted),
                              null != e.events && e.events.length)
                            )
                              for (var r = 0; r < e.events.length; ++r)
                                c.koinos.protocol.event_data
                                  .encode(e.events[r], t.uint32(82).fork())
                                  .ldelim();
                            if (null != e.logs && e.logs.length)
                              for (r = 0; r < e.logs.length; ++r)
                                t.uint32(90).string(e.logs[r]);
                            return t;
                          }),
                          (t.encodeDelimited = function (e, t) {
                            return this.encode(e, t).ldelim();
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.transaction_receipt();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 5:
                                  ...
                                  break;
                                case 6:
                                  n.disk_storage_used = e.uint64();
                                  break;
                                case 7:
                                  n.network_bandwidth_used = e.uint64();
                                  break;
                                case 8:
                                  n.compute_bandwidth_used = e.uint64();
                                  break;
                                case 9:
                                  n.reverted = e.bool();
                                  break;
                                case 10:
                                  (n.events && n.events.length) ||
                                    (n.events = []),
                                    n.events.push(
                                      c.koinos.protocol.event_data.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.max_payer_rc &&
                              e.hasOwnProperty("max_payer_rc") &&
                              !(
                                l.isInteger(e.max_payer_rc) ||
                                (e.max_payer_rc &&
                                  l.isInteger(e.max_payer_rc.low) &&
                                  l.isInteger(e.max_payer_rc.high))
                              )
                            )
                            ...
                            if (
                              null != e.rc_used &&
                              e.hasOwnProperty("rc_used") &&
                              !(
                                l.isInteger(e.rc_used) ||
                                (e.rc_used &&
                                  l.isInteger(e.rc_used.low) &&
                                  l.isInteger(e.rc_used.high))
                              )
                            )
                              return "rc_used: integer|Long expected";
                            if (
                              null != e.disk_storage_used &&
                              e.hasOwnProperty("disk_storage_used") &&
                              !(
                                l.isInteger(e.disk_storage_used) ||
                                (e.disk_storage_used &&
                                  l.isInteger(e.disk_storage_used.low) &&
                                  l.isInteger(e.disk_storage_used.high))
                              )
                            )
                              return "disk_storage_used: integer|Long expected";
                            if (
                              null != e.network_bandwidth_used &&
                              e.hasOwnProperty("network_bandwidth_used") &&
                              !(
                                l.isInteger(e.network_bandwidth_used) ||
                                (e.network_bandwidth_used &&
                                  l.isInteger(e.network_bandwidth_used.low) &&
                                  l.isInteger(e.network_bandwidth_used.high))
                              )
                            )
                              return "network_bandwidth_used: integer|Long expected";
                            if (
                              null != e.compute_bandwidth_used &&
                              e.hasOwnProperty("compute_bandwidth_used") &&
                              !(
                                l.isInteger(e.compute_bandwidth_used) ||
                                (e.compute_bandwidth_used &&
                                  l.isInteger(e.compute_bandwidth_used.low) &&
                                  l.isInteger(e.compute_bandwidth_used.high))
                              )
                            )
                              return "compute_bandwidth_used: integer|Long expected";
                            if (
                              null != e.reverted &&
                              e.hasOwnProperty("reverted") &&
                              "boolean" != typeof e.reverted
                            )
                            ...
                            if (
                              ...
                              for (var t = 0; t < e.events.length; ++t) {
                                var r = c.koinos.protocol.event_data.verify(
                                  e.events[t]
                                );
                                if (r) return "events." + r;
                              }
                            }
                            if (null != e.logs && e.hasOwnProperty("logs")) {
                              if (!Array.isArray(e.logs))
                                return "logs: array expected";
                              for (t = 0; t < e.logs.length; ++t)
                                if (!l.isString(e.logs[t]))
                          ...
                          (t.fromObject = function (e) {
                            if (
                              e instanceof c.koinos.protocol.transaction_receipt
                            )
                              return e;
                            var t = new c.koinos.protocol.transaction_receipt();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? l.base64.decode(
                              ...
                              null != e.max_payer_rc &&
                                (l.Long
                                  ? ((t.max_payer_rc = l.Long.fromValue(
                                      e.max_payer_rc
                                    )).unsigned = !0)
                                  : "string" == typeof e.max_payer_rc
                                  ? (t.max_payer_rc = parseInt(
                                      e.max_payer_rc,
                                      10
                                    ))
                                  : "number" == typeof e.max_payer_rc
                                  ? (t.max_payer_rc = e.max_payer_rc)
                                  : "object" == typeof e.max_payer_rc &&
                                    (t.max_payer_rc = new l.LongBits(
                                      e.max_payer_rc.low >>> 0,
                                      e.max_payer_rc.high >>> 0
                                    ).toNumber(!0))),
                              null != e.rc_limit &&
                                (l.Long
                                  ? ((t.rc_limit = l.Long.fromValue(
                              ...
                              null != e.rc_used &&
                                (l.Long
                                  ? ((t.rc_used = l.Long.fromValue(
                                      e.rc_used
                                    )).unsigned = !0)
                                  : "string" == typeof e.rc_used
                                  ? (t.rc_used = parseInt(e.rc_used, 10))
                                  : "number" == typeof e.rc_used
                                  ? (t.rc_used = e.rc_used)
                                  : "object" == typeof e.rc_used &&
                                    (t.rc_used = new l.LongBits(
                                      e.rc_used.low >>> 0,
                                      e.rc_used.high >>> 0
                                    ).toNumber(!0))),
                              null != e.disk_storage_used &&
                                (l.Long
                                  ? ((t.disk_storage_used = l.Long.fromValue(
                                      e.disk_storage_used
                                    )).unsigned = !0)
                                  : "string" == typeof e.disk_storage_used
                                  ? (t.disk_storage_used = parseInt(
                                      e.disk_storage_used,
                                      10
                                    ))
                                  : "number" == typeof e.disk_storage_used
                                  ? (t.disk_storage_used = e.disk_storage_used)
                                  : "object" == typeof e.disk_storage_used &&
                                    (t.disk_storage_used = new l.LongBits(
                                      e.disk_storage_used.low >>> 0,
                                      e.disk_storage_used.high >>> 0
                                    ).toNumber(!0))),
                              null != e.network_bandwidth_used &&
                                (l.Long
                                  ? ((t.network_bandwidth_used =
                                      l.Long.fromValue(
                                        e.network_bandwidth_used
                                      )).unsigned = !0)
                                  : "string" == typeof e.network_bandwidth_used
                                  ? (t.network_bandwidth_used = parseInt(
                                      e.network_bandwidth_used,
                                      10
                                    ))
                                  : "number" == typeof e.network_bandwidth_used
                                  ? (t.network_bandwidth_used =
                                      e.network_bandwidth_used)
                                  : "object" ==
                                      typeof e.network_bandwidth_used &&
                                    (t.network_bandwidth_used = new l.LongBits(
                                      e.network_bandwidth_used.low >>> 0,
                                      e.network_bandwidth_used.high >>> 0
                                    ).toNumber(!0))),
                              null != e.compute_bandwidth_used &&
                                (l.Long
                                  ? ((t.compute_bandwidth_used =
                                      l.Long.fromValue(
                                        e.compute_bandwidth_used
                                      )).unsigned = !0)
                                  : "string" == typeof e.compute_bandwidth_used
                                  ? (t.compute_bandwidth_used = parseInt(
                                      e.compute_bandwidth_used,
                                      10
                                    ))
                                  : "number" == typeof e.compute_bandwidth_used
                                  ? (t.compute_bandwidth_used =
                                      e.compute_bandwidth_used)
                                  : "object" ==
                                      typeof e.compute_bandwidth_used &&
                                    (t.compute_bandwidth_used = new l.LongBits(
                                      e.compute_bandwidth_used.low >>> 0,
                                      e.compute_bandwidth_used.high >>> 0
                                    ).toNumber(!0))),
                              null != e.reverted &&
                                (t.reverted = Boolean(e.reverted)),
                              e.events)
                            ) {
                              if (!Array.isArray(e.events))
                                throw TypeError(
                              ...
                              for (var r = 0; r < e.events.length; ++r) {
                                ...
                                t.events[r] =
                                  c.koinos.protocol.event_data.fromObject(
                                    e.events[r]
                                  );
                              }
                            }
                            if (e.logs) {
                              ...
                              for (t.logs = [], r = 0; r < e.logs.length; ++r)
                                t.logs[r] = String(e.logs[r]);
                            }
                            return t;
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ...
                              if (
                                ...
                                r.max_payer_rc = t.longs === String ? "0" : 0;
                              l.Long
                                ? ((n = new l.Long(0, 0, !0)),
                                  (r.rc_limit =
                                    t.longs === String
                            ...
                            if (
                              ...
                              null != e.network_bandwidth_used &&
                                ...
                                ("number" == typeof e.network_bandwidth_used
                                  ? (r.network_bandwidth_used =
                                      t.longs === String
                                        ? String(e.network_bandwidth_used)
                                        : e.network_bandwidth_used)
                                  : (r.network_bandwidth_used =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                              ...
                              null != e.compute_bandwidth_used &&
                                ...
                                ("number" == typeof e.compute_bandwidth_used
                                  ? (r.compute_bandwidth_used =
                                      t.longs === String
                                        ? String(e.compute_bandwidth_used)
                                        : e.compute_bandwidth_used)
                                  : (r.compute_bandwidth_used =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                              ...
                              null != e.reverted &&
                                e.hasOwnProperty("reverted") &&
                                (r.reverted = e.reverted),
                              e.events && e.events.length)
                            ) {
                              r.events = [];
                              for (var o = 0; o < e.events.length; ++o)
                                r.events[o] =
                                  c.koinos.protocol.event_data.toObject(
                                    e.events[o],
                                    t
                                  );
                            }
                            if (e.logs && e.logs.length)
                              for (r.logs = [], o = 0; o < e.logs.length; ++o)
                                r.logs[o] = e.logs[o];
                            return r;
                          }),
                          (t.prototype.toJSON = function () {
                      ...
                      (n.block_header = (function () {
                        ...
                        return (
                          (t.prototype.previous = l.newBuffer([])),
                          (t.prototype.height = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.timestamp = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.previous_state_merkle_root = l.newBuffer(
                            []
                          )),
                          (t.prototype.transaction_merkle_root = l.newBuffer(
                            []
                          )),
                          (t.prototype.signer = l.newBuffer([])),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            return (
                              t || (t = a.create()),
                              null != e.previous &&
                                Object.hasOwnProperty.call(e, "previous") &&
                                t.uint32(10).bytes(e.previous),
                              null != e.height &&
                                Object.hasOwnProperty.call(e, "height") &&
                                t.uint32(16).uint64(e.height),
                              null != e.timestamp &&
                                Object.hasOwnProperty.call(e, "timestamp") &&
                                t.uint32(24).uint64(e.timestamp),
                              null != e.previous_state_merkle_root &&
                                Object.hasOwnProperty.call(
                                  e,
                                ...
                                t
                                  .uint32(34)
                                  .bytes(e.previous_state_merkle_root),
                              null != e.transaction_merkle_root &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "transaction_merkle_root"
                                ) &&
                                t.uint32(42).bytes(e.transaction_merkle_root),
                              null != e.signer &&
                                Object.hasOwnProperty.call(e, "signer") &&
                                t.uint32(50).bytes(e.signer),
                              t
                            );
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.block_header();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 3:
                                  ...
                                  break;
                                case 4:
                                  n.previous_state_merkle_root = e.bytes();
                                  break;
                                case 5:
                                  n.transaction_merkle_root = e.bytes();
                                  break;
                                case 6:
                                  n.signer = e.bytes();
                                  break;
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ? "object expected"
                              : null != e.previous &&
                                e.hasOwnProperty("previous") &&
                                !(
                                  (e.previous &&
                                    "number" == typeof e.previous.length) ||
                                  l.isString(e.previous)
                                )
                              ? "previous: buffer expected"
                              : null != e.height &&
                                e.hasOwnProperty("height") &&
                                !(
                                  l.isInteger(e.height) ||
                                  (e.height &&
                                    l.isInteger(e.height.low) &&
                                    l.isInteger(e.height.high))
                                )
                              ? "height: integer|Long expected"
                              : null != e.timestamp &&
                                e.hasOwnProperty("timestamp") &&
                                !(
                                  l.isInteger(e.timestamp) ||
                                  (e.timestamp &&
                                    l.isInteger(e.timestamp.low) &&
                                    l.isInteger(e.timestamp.high))
                                )
                              ...
                              : null != e.previous_state_merkle_root &&
                                ...
                                !(
                                  (e.previous_state_merkle_root &&
                                    "number" ==
                                      typeof e.previous_state_merkle_root
                                        .length) ||
                                  l.isString(e.previous_state_merkle_root)
                                )
                              ? "previous_state_merkle_root: buffer expected"
                              : null != e.transaction_merkle_root &&
                                e.hasOwnProperty("transaction_merkle_root") &&
                                !(
                                  (e.transaction_merkle_root &&
                                    "number" ==
                                      typeof e.transaction_merkle_root
                                        .length) ||
                                  l.isString(e.transaction_merkle_root)
                                )
                              ? "transaction_merkle_root: buffer expected"
                              : null != e.signer &&
                                e.hasOwnProperty("signer") &&
                                !(
                                  (e.signer &&
                                    "number" == typeof e.signer.length) ||
                                  l.isString(e.signer)
                                )
                              ? "signer: buffer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.protocol.block_header)
                              return e;
                            var t = new c.koinos.protocol.block_header();
                            return (
                              null != e.previous &&
                                ("string" == typeof e.previous
                                  ? l.base64.decode(
                                      e.previous,
                                      (t.previous = l.newBuffer(
                                        l.base64.length(e.previous)
                                      )),
                                      0
                                    )
                                  : e.previous.length &&
                              ...
                              null != e.height &&
                                (l.Long
                                  ...
                                  ? (t.height = e.height)
                                  : "object" == typeof e.height &&
                                    (t.height = new l.LongBits(
                                      e.height.low >>> 0,
                                      e.height.high >>> 0
                                    ).toNumber(!0))),
                              null != e.timestamp &&
                                (l.Long
                                  ? ((t.timestamp = l.Long.fromValue(
                                      e.timestamp
                                    )).unsigned = !0)
                                  ...
                                  : "object" == typeof e.timestamp &&
                                    (t.timestamp = new l.LongBits(
                                      e.timestamp.low >>> 0,
                                      e.timestamp.high >>> 0
                                    ).toNumber(!0))),
                              null != e.previous_state_merkle_root &&
                                ("string" == typeof e.previous_state_merkle_root
                                  ? l.base64.decode(
                                      e.previous_state_merkle_root,
                                      (t.previous_state_merkle_root =
                                        l.newBuffer(
                                          l.base64.length(
                                            e.previous_state_merkle_root
                                          )
                                  ...
                                  : e.previous_state_merkle_root.length &&
                                    (t.previous_state_merkle_root =
                                      e.previous_state_merkle_root)),
                              null != e.transaction_merkle_root &&
                                ("string" == typeof e.transaction_merkle_root
                                  ? l.base64.decode(
                                      e.transaction_merkle_root,
                                      (t.transaction_merkle_root = l.newBuffer(
                                        l.base64.length(
                                          e.transaction_merkle_root
                                        )
                                      )),
                                  ...
                                  : e.transaction_merkle_root.length &&
                                    (t.transaction_merkle_root =
                                      e.transaction_merkle_root)),
                              null != e.signer &&
                                ("string" == typeof e.signer
                                  ? l.base64.decode(
                                      e.signer,
                                      (t.signer = l.newBuffer(
                                        l.base64.length(e.signer)
                                      )),
                                      0
                                    )
                                  : e.signer.length && (t.signer = e.signer)),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            if (t.defaults) {
                              if (
                                (t.bytes === String
                                  ...
                                  : ((r.previous = []),
                                    t.bytes !== Array &&
                                      (r.previous = l.newBuffer(r.previous))),
                                l.Long)
                              ) {
                                var n = new l.Long(0, 0, !0);
                                r.height =
                                  t.longs === String
                                    ...
                                    ? n.toNumber()
                                    : n;
                              } else r.height = t.longs === String ? "0" : 0;
                              l.Long
                                ? ((n = new l.Long(0, 0, !0)),
                                  (r.timestamp =
                                    t.longs === String
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.transaction_merkle_root = []),
                                    t.bytes !== Array &&
                                      (r.transaction_merkle_root = l.newBuffer(
                                        r.transaction_merkle_root
                                      ))),
                                t.bytes === String
                                  ? (r.signer = "")
                              ...
                              null != e.previous &&
                                ...
                                (r.previous =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.previous)
                                    : e.previous),
                              null != e.height &&
                                e.hasOwnProperty("height") &&
                                ("number" == typeof e.height
                              ...
                              null != e.signer &&
                                ...
                                (r.signer =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.signer)
                                    : e.signer),
                              r
                            );
                          }),
                      ...
                      (n.block = (function () {
                        ...
                        return (
                          (t.prototype.id = l.newBuffer([])),
                          (t.prototype.header = null),
                          (t.prototype.transactions = l.emptyArray),
                          (t.prototype.signature = l.newBuffer([])),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              ...
                              switch (o >>> 3) {
                                ...
                                case 2:
                                  n.header =
                                    c.koinos.protocol.block_header.decode(
                                      e,
                                      e.uint32()
                                    );
                                  break;
                                case 3:
                                  (n.transactions && n.transactions.length) ||
                                    (n.transactions = []),
                                    n.transactions.push(
                                      c.koinos.protocol.transaction.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.header &&
                              e.hasOwnProperty("header") &&
                              (r = c.koinos.protocol.block_header.verify(
                                e.header
                              ))
                            )
                              return "header." + r;
                            if (
                              ...
                              for (var t = 0; t < e.transactions.length; ++t) {
                                var r;
                                if (
                                  (r = c.koinos.protocol.transaction.verify(
                                    e.transactions[t]
                                  ))
                                )
                            ...
                            return null != e.signature &&
                              e.hasOwnProperty("signature") &&
                              !(
                                (e.signature &&
                                  "number" == typeof e.signature.length) ||
                                l.isString(e.signature)
                              )
                              ? "signature: buffer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.protocol.block) return e;
                            var t = new c.koinos.protocol.block();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? l.base64.decode(
                              ...
                              if ("object" != typeof e.header)
                                throw TypeError(
                                  ".koinos.protocol.block.header: object expected"
                                );
                              t.header =
                                c.koinos.protocol.block_header.fromObject(
                                  e.header
                                );
                            }
                            if (e.transactions) {
                              ...
                              for (var r = 0; r < e.transactions.length; ++r) {
                                ...
                                t.transactions[r] =
                                  c.koinos.protocol.transaction.fromObject(
                                    e.transactions[r]
                                  );
                              }
                            }
                            return (
                              null != e.signature &&
                                ("string" == typeof e.signature
                                  ? l.base64.decode(
                                      e.signature,
                                      (t.signature = l.newBuffer(
                                        l.base64.length(e.signature)
                                      )),
                                      0
                                    )
                                  : e.signature.length &&
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ...
                              null != e.header &&
                                e.hasOwnProperty("header") &&
                                (r.header =
                                  c.koinos.protocol.block_header.toObject(
                                    e.header,
                                    t
                                  )),
                              ...
                              for (var n = 0; n < e.transactions.length; ++n)
                                r.transactions[n] =
                                  c.koinos.protocol.transaction.toObject(
                                    e.transactions[n],
                                    t
                                  );
                            }
                      ...
                      (n.block_receipt = (function () {
                        ...
                        return (
                          ...
                          (t.prototype.compute_bandwidth_used = l.Long
                            ? l.Long.fromBits(0, 0, !0)
                            : 0),
                          (t.prototype.state_merkle_root = l.newBuffer([])),
                          (t.prototype.events = l.emptyArray),
                          (t.prototype.transaction_receipts = l.emptyArray),
                          (t.prototype.logs = l.emptyArray),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                            if (
                              ...
                              null != e.network_bandwidth_used &&
                                ...
                                t.uint32(32).uint64(e.network_bandwidth_used),
                              null != e.compute_bandwidth_used &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "compute_bandwidth_used"
                              ...
                              null != e.state_merkle_root &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "state_merkle_root"
                                ) &&
                                t.uint32(50).bytes(e.state_merkle_root),
                              null != e.events && e.events.length)
                            )
                              for (var r = 0; r < e.events.length; ++r)
                                c.koinos.protocol.event_data
                                  .encode(e.events[r], t.uint32(58).fork())
                                  .ldelim();
                            if (
                              null != e.transaction_receipts &&
                              e.transaction_receipts.length
                            )
                              for (
                                r = 0;
                                r < e.transaction_receipts.length;
                                ++r
                              )
                                c.koinos.protocol.transaction_receipt
                                  .encode(
                                    e.transaction_receipts[r],
                                    t.uint32(66).fork()
                                  )
                                  .ldelim();
                            if (null != e.logs && e.logs.length)
                              for (r = 0; r < e.logs.length; ++r)
                                t.uint32(74).string(e.logs[r]);
                            return t;
                          }),
                          (t.encodeDelimited = function (e, t) {
                            return this.encode(e, t).ldelim();
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.protocol.block_receipt();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                ...
                                case 7:
                                  ...
                                  break;
                                case 8:
                                  (n.transaction_receipts &&
                                    n.transaction_receipts.length) ||
                                    (n.transaction_receipts = []),
                                    n.transaction_receipts.push(
                                      c.koinos.protocol.transaction_receipt.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.state_merkle_root &&
                              e.hasOwnProperty("state_merkle_root") &&
                              !(
                                (e.state_merkle_root &&
                                  "number" ==
                                    typeof e.state_merkle_root.length) ||
                                l.isString(e.state_merkle_root)
                              )
                            )
                            ...
                            if (
                              ...
                              for (var t = 0; t < e.events.length; ++t)
                                if (
                                  (r = c.koinos.protocol.event_data.verify(
                                    e.events[t]
                                  ))
                                )
                                  return "events." + r;
                            ...
                            if (
                              null != e.transaction_receipts &&
                              e.hasOwnProperty("transaction_receipts")
                            ) {
                              if (!Array.isArray(e.transaction_receipts))
                                return "transaction_receipts: array expected";
                              for (
                                t = 0;
                                t < e.transaction_receipts.length;
                                ++t
                              ) {
                                var r;
                                if (
                                  (r =
                                    c.koinos.protocol.transaction_receipt.verify(
                                      e.transaction_receipts[t]
                                    ))
                                )
                                  return "transaction_receipts." + r;
                              }
                            }
                            if (null != e.logs && e.hasOwnProperty("logs")) {
                              if (!Array.isArray(e.logs))
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.protocol.block_receipt)
                              return e;
                            var t = new c.koinos.protocol.block_receipt();
                            if (
                              (null != e.id &&
                                ("string" == typeof e.id
                                  ? l.base64.decode(
                              ...
                              null != e.state_merkle_root &&
                                ("string" == typeof e.state_merkle_root
                                  ? l.base64.decode(
                                      e.state_merkle_root,
                                      (t.state_merkle_root = l.newBuffer(
                                        l.base64.length(e.state_merkle_root)
                                      )),
                                      0
                                    )
                                  : e.state_merkle_root.length &&
                                    (t.state_merkle_root =
                                      e.state_merkle_root)),
                              e.events)
                            ) {
                            ...
                            if (e.transaction_receipts) {
                              if (!Array.isArray(e.transaction_receipts))
                                throw TypeError(
                                  ".koinos.protocol.block_receipt.transaction_receipts: array expected"
                                );
                              for (
                                t.transaction_receipts = [], r = 0;
                                r < e.transaction_receipts.length;
                                ++r
                              ) {
                                if (
                                  "object" != typeof e.transaction_receipts[r]
                                )
                                  throw TypeError(
                                    ".koinos.protocol.block_receipt.transaction_receipts: object expected"
                                  );
                                t.transaction_receipts[r] =
                                  c.koinos.protocol.transaction_receipt.fromObject(
                                    e.transaction_receipts[r]
                                  );
                              }
                            }
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            if (
                              ...
                              l.Long
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.state_merkle_root = []),
                                    t.bytes !== Array &&
                                      (r.state_merkle_root = l.newBuffer(
                                        r.state_merkle_root
                                      )));
                            }
                            if (
                            ...
                            if (
                              e.transaction_receipts &&
                              e.transaction_receipts.length
                            )
                              for (
                                r.transaction_receipts = [], o = 0;
                                o < e.transaction_receipts.length;
                                ++o
                              )
                                r.transaction_receipts[o] =
                                  c.koinos.protocol.transaction_receipt.toObject(
                                    e.transaction_receipts[o],
                                    t
                                  );
                            if (e.logs && e.logs.length)
                              for (r.logs = [], o = 0; o < e.logs.length; ++o)
                    ...
                    (i.chain =
                      (((o = {}).value_type = (function () {
                        ...
                        var r;
                        return (
                          (t.prototype.message_value = null),
                          (t.prototype.double_value = null),
                          (t.prototype.float_value = null),
                          (t.prototype.int32_value = null),
                          (t.prototype.int64_value = null),
                          (t.prototype.uint32_value = null),
                          (t.prototype.uint64_value = null),
                          (t.prototype.sint32_value = null),
                          (t.prototype.sint64_value = null),
                          (t.prototype.fixed32_value = null),
                          (t.prototype.fixed64_value = null),
                          (t.prototype.sfixed32_value = null),
                          (t.prototype.sfixed64_value = null),
                          (t.prototype.bool_value = null),
                          (t.prototype.string_value = null),
                          (t.prototype.bytes_value = null),
                          ...
                          (t.encode = function (e, t) {
                            return (
                              t || (t = a.create()),
                              null != e.message_value &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "message_value"
                                ) &&
                                c.google.protobuf.Any.encode(
                                  e.message_value,
                                  t.uint32(10).fork()
                                ).ldelim(),
                              null != e.double_value &&
                                Object.hasOwnProperty.call(e, "double_value") &&
                                t.uint32(17).double(e.double_value),
                              null != e.float_value &&
                                Object.hasOwnProperty.call(e, "float_value") &&
                                t.uint32(29).float(e.float_value),
                              null != e.int32_value &&
                                Object.hasOwnProperty.call(e, "int32_value") &&
                                t.uint32(32).int32(e.int32_value),
                              null != e.int64_value &&
                                Object.hasOwnProperty.call(e, "int64_value") &&
                                t.uint32(40).int64(e.int64_value),
                              null != e.uint32_value &&
                                Object.hasOwnProperty.call(e, "uint32_value") &&
                                t.uint32(48).uint32(e.uint32_value),
                              null != e.uint64_value &&
                                Object.hasOwnProperty.call(e, "uint64_value") &&
                                t.uint32(56).uint64(e.uint64_value),
                              null != e.sint32_value &&
                                Object.hasOwnProperty.call(e, "sint32_value") &&
                                t.uint32(64).sint32(e.sint32_value),
                              null != e.sint64_value &&
                                Object.hasOwnProperty.call(e, "sint64_value") &&
                                t.uint32(72).sint64(e.sint64_value),
                              null != e.fixed32_value &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "fixed32_value"
                                ) &&
                                t.uint32(85).fixed32(e.fixed32_value),
                              null != e.fixed64_value &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "fixed64_value"
                                ) &&
                                t.uint32(89).fixed64(e.fixed64_value),
                              null != e.sfixed32_value &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "sfixed32_value"
                                ) &&
                                t.uint32(101).sfixed32(e.sfixed32_value),
                              null != e.sfixed64_value &&
                                Object.hasOwnProperty.call(
                                  e,
                                  "sfixed64_value"
                                ) &&
                                t.uint32(105).sfixed64(e.sfixed64_value),
                              null != e.bool_value &&
                                Object.hasOwnProperty.call(e, "bool_value") &&
                                t.uint32(112).bool(e.bool_value),
                              null != e.string_value &&
                                Object.hasOwnProperty.call(e, "string_value") &&
                                t.uint32(122).string(e.string_value),
                              null != e.bytes_value &&
                                Object.hasOwnProperty.call(e, "bytes_value") &&
                                t.uint32(130).bytes(e.bytes_value),
                              t
                            );
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.chain.value_type();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  n.message_value =
                                    c.google.protobuf.Any.decode(e, e.uint32());
                                  break;
                                case 2:
                                  n.double_value = e.double();
                                  break;
                                case 3:
                                  n.float_value = e.float();
                                  break;
                                case 4:
                                  n.int32_value = e.int32();
                                  break;
                                case 5:
                                  n.int64_value = e.int64();
                                  break;
                                case 6:
                                  n.uint32_value = e.uint32();
                                  break;
                                case 7:
                                  n.uint64_value = e.uint64();
                                  break;
                                case 8:
                                  n.sint32_value = e.sint32();
                                  break;
                                case 9:
                                  n.sint64_value = e.sint64();
                                  break;
                                case 10:
                                  n.fixed32_value = e.fixed32();
                                  break;
                                case 11:
                                  n.fixed64_value = e.fixed64();
                                  break;
                                case 12:
                                  n.sfixed32_value = e.sfixed32();
                                  break;
                                case 13:
                                  n.sfixed64_value = e.sfixed64();
                                  break;
                                case 14:
                                  n.bool_value = e.bool();
                                  break;
                                case 15:
                                  n.string_value = e.string();
                                  break;
                                case 16:
                                  n.bytes_value = e.bytes();
                                  break;
                                default:
                                  e.skipType(7 & o);
                              }
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              null != e.message_value &&
                              e.hasOwnProperty("message_value")
                            ) {
                              t.kind = 1;
                              var r = c.google.protobuf.Any.verify(
                                e.message_value
                              );
                              if (r) return "message_value." + r;
                            }
                            if (
                              null != e.double_value &&
                              e.hasOwnProperty("double_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1),
                                "number" != typeof e.double_value)
                              )
                                return "double_value: number expected";
                            }
                            if (
                              null != e.float_value &&
                              e.hasOwnProperty("float_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1), "number" != typeof e.float_value)
                              )
                                return "float_value: number expected";
                            }
                            if (
                              null != e.int32_value &&
                              e.hasOwnProperty("int32_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !l.isInteger(e.int32_value)))
                                return "int32_value: integer expected";
                            }
                            if (
                              null != e.int64_value &&
                              e.hasOwnProperty("int64_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1),
                                !(
                                  l.isInteger(e.int64_value) ||
                                  (e.int64_value &&
                                    l.isInteger(e.int64_value.low) &&
                                    l.isInteger(e.int64_value.high))
                                ))
                              )
                            ...
                            if (
                              null != e.uint32_value &&
                              e.hasOwnProperty("uint32_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !l.isInteger(e.uint32_value)))
                                return "uint32_value: integer expected";
                            }
                            if (
                              null != e.uint64_value &&
                              e.hasOwnProperty("uint64_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1),
                                !(
                                  l.isInteger(e.uint64_value) ||
                                  (e.uint64_value &&
                                    l.isInteger(e.uint64_value.low) &&
                                    l.isInteger(e.uint64_value.high))
                                ))
                              )
                            ...
                            if (
                              null != e.sint32_value &&
                              e.hasOwnProperty("sint32_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !l.isInteger(e.sint32_value)))
                                return "sint32_value: integer expected";
                            }
                            if (
                              null != e.sint64_value &&
                              e.hasOwnProperty("sint64_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1),
                                !(
                                  l.isInteger(e.sint64_value) ||
                                  (e.sint64_value &&
                                    l.isInteger(e.sint64_value.low) &&
                                    l.isInteger(e.sint64_value.high))
                                ))
                              )
                            ...
                            if (
                              null != e.fixed32_value &&
                              e.hasOwnProperty("fixed32_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !l.isInteger(e.fixed32_value)))
                                return "fixed32_value: integer expected";
                            }
                            if (
                              null != e.fixed64_value &&
                              e.hasOwnProperty("fixed64_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1),
                                !(
                                  l.isInteger(e.fixed64_value) ||
                                  (e.fixed64_value &&
                                    l.isInteger(e.fixed64_value.low) &&
                                    l.isInteger(e.fixed64_value.high))
                                ))
                              )
                            ...
                            if (
                              null != e.sfixed32_value &&
                              e.hasOwnProperty("sfixed32_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1), !l.isInteger(e.sfixed32_value))
                              )
                                return "sfixed32_value: integer expected";
                            }
                            if (
                              null != e.sfixed64_value &&
                              e.hasOwnProperty("sfixed64_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1),
                                !(
                                  l.isInteger(e.sfixed64_value) ||
                                  (e.sfixed64_value &&
                                    l.isInteger(e.sfixed64_value.low) &&
                                    l.isInteger(e.sfixed64_value.high))
                                ))
                              )
                            ...
                            if (
                              null != e.bool_value &&
                              e.hasOwnProperty("bool_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1), "boolean" != typeof e.bool_value)
                              )
                                return "bool_value: boolean expected";
                            }
                            if (
                              null != e.string_value &&
                              e.hasOwnProperty("string_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (((t.kind = 1), !l.isString(e.string_value)))
                                return "string_value: string expected";
                            }
                            if (
                              null != e.bytes_value &&
                              e.hasOwnProperty("bytes_value")
                            ) {
                              if (1 === t.kind) return "kind: multiple values";
                              if (
                                ((t.kind = 1),
                                !(
                                  (e.bytes_value &&
                                    "number" == typeof e.bytes_value.length) ||
                                  l.isString(e.bytes_value)
                                ))
                              )
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.chain.value_type)
                              return e;
                            var t = new c.koinos.chain.value_type();
                            if (null != e.message_value) {
                              if ("object" != typeof e.message_value)
                                throw TypeError(
                                  ".koinos.chain.value_type.message_value: object expected"
                                );
                              t.message_value =
                                c.google.protobuf.Any.fromObject(
                                  e.message_value
                                );
                            }
                            return (
                              null != e.double_value &&
                                (t.double_value = Number(e.double_value)),
                              null != e.float_value &&
                                (t.float_value = Number(e.float_value)),
                              null != e.int32_value &&
                                (t.int32_value = 0 | e.int32_value),
                              null != e.int64_value &&
                                (l.Long
                                  ? ((t.int64_value = l.Long.fromValue(
                                      e.int64_value
                                    )).unsigned = !1)
                                  : "string" == typeof e.int64_value
                                  ? (t.int64_value = parseInt(
                                      e.int64_value,
                                      10
                                    ))
                                  : "number" == typeof e.int64_value
                                  ? (t.int64_value = e.int64_value)
                                  : "object" == typeof e.int64_value &&
                                    (t.int64_value = new l.LongBits(
                                      e.int64_value.low >>> 0,
                                      e.int64_value.high >>> 0
                                    ).toNumber())),
                              null != e.uint32_value &&
                                (t.uint32_value = e.uint32_value >>> 0),
                              null != e.uint64_value &&
                                (l.Long
                                  ? ((t.uint64_value = l.Long.fromValue(
                                      e.uint64_value
                                    )).unsigned = !0)
                                  : "string" == typeof e.uint64_value
                                  ? (t.uint64_value = parseInt(
                                      e.uint64_value,
                                      10
                                    ))
                                  : "number" == typeof e.uint64_value
                                  ? (t.uint64_value = e.uint64_value)
                                  : "object" == typeof e.uint64_value &&
                                    (t.uint64_value = new l.LongBits(
                                      e.uint64_value.low >>> 0,
                                      e.uint64_value.high >>> 0
                                    ).toNumber(!0))),
                              null != e.sint32_value &&
                                (t.sint32_value = 0 | e.sint32_value),
                              null != e.sint64_value &&
                                (l.Long
                                  ? ((t.sint64_value = l.Long.fromValue(
                                      e.sint64_value
                                    )).unsigned = !1)
                                  : "string" == typeof e.sint64_value
                                  ? (t.sint64_value = parseInt(
                                      e.sint64_value,
                                      10
                                    ))
                                  : "number" == typeof e.sint64_value
                                  ? (t.sint64_value = e.sint64_value)
                                  : "object" == typeof e.sint64_value &&
                                    (t.sint64_value = new l.LongBits(
                                      e.sint64_value.low >>> 0,
                                      e.sint64_value.high >>> 0
                                    ).toNumber())),
                              null != e.fixed32_value &&
                                (t.fixed32_value = e.fixed32_value >>> 0),
                              null != e.fixed64_value &&
                                (l.Long
                                  ? ((t.fixed64_value = l.Long.fromValue(
                                      e.fixed64_value
                                    )).unsigned = !1)
                                  : "string" == typeof e.fixed64_value
                                  ? (t.fixed64_value = parseInt(
                                      e.fixed64_value,
                                      10
                                    ))
                                  : "number" == typeof e.fixed64_value
                                  ? (t.fixed64_value = e.fixed64_value)
                                  : "object" == typeof e.fixed64_value &&
                                    (t.fixed64_value = new l.LongBits(
                                      e.fixed64_value.low >>> 0,
                                      e.fixed64_value.high >>> 0
                                    ).toNumber())),
                              null != e.sfixed32_value &&
                                (t.sfixed32_value = 0 | e.sfixed32_value),
                              null != e.sfixed64_value &&
                                (l.Long
                                  ? ((t.sfixed64_value = l.Long.fromValue(
                                      e.sfixed64_value
                                    )).unsigned = !1)
                                  : "string" == typeof e.sfixed64_value
                                  ? (t.sfixed64_value = parseInt(
                                      e.sfixed64_value,
                                      10
                                    ))
                                  : "number" == typeof e.sfixed64_value
                                  ? (t.sfixed64_value = e.sfixed64_value)
                                  : "object" == typeof e.sfixed64_value &&
                                    (t.sfixed64_value = new l.LongBits(
                                      e.sfixed64_value.low >>> 0,
                                      e.sfixed64_value.high >>> 0
                                    ).toNumber())),
                              null != e.bool_value &&
                                (t.bool_value = Boolean(e.bool_value)),
                              null != e.string_value &&
                                (t.string_value = String(e.string_value)),
                              null != e.bytes_value &&
                                ("string" == typeof e.bytes_value
                                  ? l.base64.decode(
                                      e.bytes_value,
                                      (t.bytes_value = l.newBuffer(
                                        l.base64.length(e.bytes_value)
                                      )),
                                      0
                                    )
                                  : e.bytes_value.length &&
                                    (t.bytes_value = e.bytes_value)),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                            ...
                            return (
                              null != e.message_value &&
                                e.hasOwnProperty("message_value") &&
                                ((r.message_value =
                                  c.google.protobuf.Any.toObject(
                                    e.message_value,
                                    t
                                  )),
                                t.oneofs && (r.kind = "message_value")),
                              null != e.double_value &&
                                e.hasOwnProperty("double_value") &&
                                ((r.double_value =
                                  t.json && !isFinite(e.double_value)
                                    ? String(e.double_value)
                                    : e.double_value),
                                t.oneofs && (r.kind = "double_value")),
                              null != e.float_value &&
                                e.hasOwnProperty("float_value") &&
                                ((r.float_value =
                                  t.json && !isFinite(e.float_value)
                                    ? String(e.float_value)
                                    : e.float_value),
                                t.oneofs && (r.kind = "float_value")),
                              null != e.int32_value &&
                                e.hasOwnProperty("int32_value") &&
                                ((r.int32_value = e.int32_value),
                                t.oneofs && (r.kind = "int32_value")),
                              null != e.int64_value &&
                                e.hasOwnProperty("int64_value") &&
                                ("number" == typeof e.int64_value
                                  ? (r.int64_value =
                                      t.longs === String
                                        ? String(e.int64_value)
                                        : e.int64_value)
                                  : (r.int64_value =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                                        ...
                                        : e.int64_value),
                                t.oneofs && (r.kind = "int64_value")),
                              null != e.uint32_value &&
                                e.hasOwnProperty("uint32_value") &&
                                ((r.uint32_value = e.uint32_value),
                                t.oneofs && (r.kind = "uint32_value")),
                              null != e.uint64_value &&
                                e.hasOwnProperty("uint64_value") &&
                                ("number" == typeof e.uint64_value
                                  ? (r.uint64_value =
                                      t.longs === String
                                        ? String(e.uint64_value)
                                        : e.uint64_value)
                                  : (r.uint64_value =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                                        ...
                                        : e.uint64_value),
                                t.oneofs && (r.kind = "uint64_value")),
                              null != e.sint32_value &&
                                e.hasOwnProperty("sint32_value") &&
                                ((r.sint32_value = e.sint32_value),
                                t.oneofs && (r.kind = "sint32_value")),
                              null != e.sint64_value &&
                                e.hasOwnProperty("sint64_value") &&
                                ("number" == typeof e.sint64_value
                                  ? (r.sint64_value =
                                      t.longs === String
                                        ? String(e.sint64_value)
                                        : e.sint64_value)
                                  : (r.sint64_value =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                                        ...
                                        : e.sint64_value),
                                t.oneofs && (r.kind = "sint64_value")),
                              null != e.fixed32_value &&
                                e.hasOwnProperty("fixed32_value") &&
                                ((r.fixed32_value = e.fixed32_value),
                                t.oneofs && (r.kind = "fixed32_value")),
                              null != e.fixed64_value &&
                                e.hasOwnProperty("fixed64_value") &&
                                ("number" == typeof e.fixed64_value
                                  ? (r.fixed64_value =
                                      t.longs === String
                                        ? String(e.fixed64_value)
                                        : e.fixed64_value)
                                  : (r.fixed64_value =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                                        ...
                                        : e.fixed64_value),
                                t.oneofs && (r.kind = "fixed64_value")),
                              null != e.sfixed32_value &&
                                e.hasOwnProperty("sfixed32_value") &&
                                ((r.sfixed32_value = e.sfixed32_value),
                                t.oneofs && (r.kind = "sfixed32_value")),
                              null != e.sfixed64_value &&
                                e.hasOwnProperty("sfixed64_value") &&
                                ("number" == typeof e.sfixed64_value
                                  ? (r.sfixed64_value =
                                      t.longs === String
                                        ? String(e.sfixed64_value)
                                        : e.sfixed64_value)
                                  : (r.sfixed64_value =
                                      t.longs === String
                                        ? l.Long.prototype.toString.call(
                                        ...
                                        : e.sfixed64_value),
                                t.oneofs && (r.kind = "sfixed64_value")),
                              null != e.bool_value &&
                                e.hasOwnProperty("bool_value") &&
                                ((r.bool_value = e.bool_value),
                                t.oneofs && (r.kind = "bool_value")),
                              null != e.string_value &&
                                e.hasOwnProperty("string_value") &&
                                ((r.string_value = e.string_value),
                                t.oneofs && (r.kind = "string_value")),
                              null != e.bytes_value &&
                                e.hasOwnProperty("bytes_value") &&
                                ((r.bytes_value =
                                  t.bytes === String
                                    ...
                                    : t.bytes === Array
                                    ? Array.prototype.slice.call(e.bytes_value)
                                    : e.bytes_value),
                                t.oneofs && (r.kind = "bytes_value")),
                              r
                            );
                          }),
                          (t.prototype.toJSON = function () {
                        ...
                        return (
                          ...
                          (t.encode = function (e, t) {
                            return (
                              ...
                              null != e.number &&
                                Object.hasOwnProperty.call(e, "number") &&
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.chain.enum_type();
                              e.pos < r;
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ...
                              : null != e.number &&
                                ...
                                !l.isInteger(e.number)
                              ? "number: integer expected"
                              : null;
                          }),
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.chain.enum_type) return e;
                            var t = new c.koinos.chain.enum_type();
                            return (
                              null != e.name && (t.name = String(e.name)),
                              null != e.number && (t.number = 0 | e.number),
                              t
                            );
                          }),
                          (t.toObject = function (e, t) {
                      ...
                      (o.list_type = (function () {
                        ...
                        return (
                          ...
                          (t.encode = function (e, t) {
                            if (
                              ...
                              for (var r = 0; r < e.values.length; ++r)
                                c.koinos.chain.value_type
                                  .encode(e.values[r], t.uint32(10).fork())
                                  .ldelim();
                            return t;
                          }),
                          (t.encodeDelimited = function (e, t) {
                          ...
                          (t.decode = function (e, t) {
                            ...
                            for (
                              var r = void 0 === t ? e.len : e.pos + t,
                                n = new c.koinos.chain.list_type();
                              e.pos < r;
                              ...
                              switch (o >>> 3) {
                                case 1:
                                  (n.values && n.values.length) ||
                                    (n.values = []),
                                    n.values.push(
                                      c.koinos.chain.value_type.decode(
                                        e,
                                        e.uint32()
                                      )
                                    );
                          ...
                          (t.verify = function (e) {
                            ...
                            if (
                              ...
                              for (var t = 0; t < e.values.length; ++t) {
                                var r = c.koinos.chain.value_type.verify(
                                  e.values[t]
                                );
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof c.koinos.chain.list_type) return e;
                            var t = new c.koinos.chain.list_type();
                            if (e.values) {
                              if (!Array.isArray(e.values))
                                throw TypeError(
                                  ".koinos.chain.list_type.values: array expected"
                                );
                              t.values = [];
                              for (var r = 0; r < e.values.length; ++r) {
                                if ("object" != typeof e.values[r])
                                  throw TypeError(
                                    ".koinos.chain.list_type.values: object expected"
                                  );
                                t.values[r] =
                                  c.koinos.chain.value_type.fromObject(
                                    e.values[r]
                                  );
                              }
                            }
                          ...
                          (t.toObject = function (e, t) {
                            ...
                            var r = {};
                            if (
                              ((t.arrays || t.defaults) && (r.values = []),
                              e.values && e.values.length)
                            ) {
                              r.values = [];
                              for (var n = 0; n < e.values.length; ++n)
                                r.values[n] =
                                  c.koinos.chain.value_type.toObject(
                                    e.values[n],
                                    t
                                  );
                            }
                  ...
                  (c.google =
                    (((r = {}).protobuf =
                      (((t = {}).Any = (function () {
                        ...
                        return (
                          (t.prototype.type_url = ""),
                          (t.prototype.value = l.newBuffer([])),
                          (t.create = function (e) {
                            return new t(e);
                          }),
                          (t.encode = function (e, t) {
                          ...
                          (t.verify = function (e) {
                            return "object" != typeof e || null === e
                              ? "object expected"
                              : null != e.type_url &&
                                e.hasOwnProperty("type_url") &&
                                !l.isString(e.type_url)
                              ? "type_url: string expected"
                              : null != e.value &&
                          ...
                          (t.fromObject = function (e) {
                            if (e instanceof c.google.protobuf.Any) return e;
                            var t = new c.google.protobuf.Any();
                            return (
                              null != e.type_url &&
                            ...
                            return (
                              t.defaults &&
                                ...
                                t.bytes === String
                                  ...
                                  : ((r.value = []),
                                    t.bytes !== Array &&
                                      (r.value = l.newBuffer(r.value)))),
                              null != e.type_url &&
                                e.hasOwnProperty("type_url") &&
                                (r.type_url = e.type_url),
                              null != e.value &&
                                e.hasOwnProperty("value") &&
                                (r.value =
                                  t.bytes === String
